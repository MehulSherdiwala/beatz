<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMaster.Master" AutoEventWireup="true" CodeBehind="edit_artist.aspx.cs" Inherits="beatz.admin.edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="header pb-6 d-flex align-items-center"
             ...
             <div class="container-fluid d-flex flex-column justify-content-center align-items-center col">
                 <div class="row">
                     <h1 class="display-1 text-white">Edit Artist</h1>
                 </div>
                 <div class="row">
                 ...
                 <div class="card-body">
                       <div class="pl-lg-4 pt-4">
                          <div class="row">
                             ...
                             <div class="col-lg-5 offset-lg-1">
                                <div class="form-group ">
                                    ...
                                    <br />
                                    <asp:Image ID="album_img" runat="server" CssClass="img-fluid img-thumbnail" Width="20%" style="float: left;margin-right: 10px;" />
                                    <asp:FileUpload ID="fu_image" CssClass="form-control" runat="server" Width="75%" />
                                </div>
                             </div>
                             <div class="col-lg-5">
                                <div class="form-group ">
                          ...
                          <div class="row flex justify-content-center">
                              ...
                              <asp:Button ID="editArtist" CssClass="btn btn-success px-5 my-4" runat="server" Text="Save" OnClick="editArtist_Click"  />
                          </div>
                       </div>
                 </div>
            </div>
