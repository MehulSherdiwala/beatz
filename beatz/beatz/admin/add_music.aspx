<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMaster.Master" AutoEventWireup="true" CodeBehind="add_music.aspx.cs" Inherits="beatz.admin.add_music" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header pb-6 d-flex align-items-center"
             ...
             <div class="container-fluid d-flex flex-column justify-content-center align-items-center col">
                 <div class="row">
                     <h1 class="display-1 text-white">Add Music</h1>
                 </div>
                 <div class="row">
                 ...
                 <div class="card-body">
                    <div class="pl-lg-4 pt-4">
                        ...
                        <div class="row flex justify-content-center">
                            <asp:Button ID="addMusic" runat="server" Text="Add Music" CssClass="btn btn-success px-5 my-4" OnClick="addMusic_Click" />
                        </div>
                    </div>
                 </div>
            </div>
