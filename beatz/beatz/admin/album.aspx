<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMaster.Master" AutoEventWireup="true" CodeBehind="album.aspx.cs" Inherits="beatz.admin.album" %>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="./add_album.aspx" class="btn btn-secondary text-success">Add Album</a>
            </div>
          </div>
        </div>
      </div>
