if (function (e, t) {
        ...
        w.fn = w.prototype = {
            ...
            var e, t, i, n, s, o, r = arguments[0] || {},
                ...
                l = arguments.length,
                u = !1;
            for ("boolean" == typeof r && (u = r, r = arguments[a] || {}, a++), "object" == typeof r || f(r) || (r = {}), a === l && (r = this, a--); a < l; a++)
                if (null != (e = arguments[a]))
                    for (t in e) n = e[t], "__proto__" !== t && r !== n && (u && n && (w.isPlainObject(n) || (s = Array.isArray(n))) ? (i = r[t], o = s && !Array.isArray(i) ? [] : s || w.isPlainObject(i) ? i : {}, s = !1, r[t] = w.extend(u, o, n)) : void 0 !== n && (r[t] = n));
            return r
        }, w.extend({
        ...
        var S = function (e) {
            var t, i, n, s, o, r, a, l, u, c, d, h, p, f, m, g, v, y, b, _ = "sizzle" + 1 * new Date,
                w = e.document,
                T = 0,
                S = 0,
                k = le(),
            ...
            try {
                D.apply(A = I.call(w.childNodes), w.childNodes), A[w.childNodes.length].nodeType
            } catch (t) {
                D = {
            ...
            function ae(e, t, n, s) {
                var o, a, u, c, d, f, v, y = t && t.ownerDocument,
                    w = t ? t.nodeType : 9;
                ...
                if (!s && (h(t), t = t || p, m)) {
                    if (11 !== w && (d = Z.exec(e)))
                        if (o = d[1]) {
                            ...
                            if ((o = d[3]) && i.getElementsByClassName && t.getElementsByClassName) return D.apply(n, t.getElementsByClassName(o)), n
                        } if (i.qsa && !j[e + " "] && (!g || !g.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                        if (v = e, y = t, 1 === w && (V.test(e) || U.test(e))) {
                            for ((y = ee.test(e) && ve(t.parentNode) || t) === t && i.scope || ((c = t.getAttribute("id")) ? c = c.replace(ne, se) : t.setAttribute("id", c = _)), a = (f = r(e)).length; a--;) f[a] = (c ? "#" + c : ":scope") + " " + be(f[a]);
                            v = f.join(",")
                        }
                        try {
            ...
            for (t in i = ae.support = {}, o = ae.isXML = function (e) {
                    ...
                    return r != p && 9 === r.nodeType && r.documentElement && (f = (p = r).documentElement, m = !o(p), w != p && (s = p.defaultView) && s.top !== s && (s.addEventListener ? s.addEventListener("unload", oe, !1) : s.attachEvent && s.attachEvent("onunload", oe)), i.scope = ce(function (e) {
                    ...
                    }, v = [], g = [], (i.qsa = J.test(p.querySelectorAll)) && (ce(function (e) {
                        var t;
                        ...
                        return n || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !i.sortDetached && t.compareDocumentPosition(e) === n ? e == p || e.ownerDocument == w && b(w, e) ? -1 : t == p || t.ownerDocument == w && b(w, t) ? 1 : c ? L(c, e) - L(c, t) : 0 : 4 & n ? -1 : 1)
                    } : function (e, t) {
                        if (e === t) return d = !0, 0;
                        var i, n = 0,
                            s = e.parentNode,
                            ...
                            r = [e],
                            a = [t];
                        if (!s || !o) return e == p ? -1 : t == p ? 1 : s ? -1 : o ? 1 : c ? L(c, e) - L(c, t) : 0;
                        if (s === o) return he(e, t);
                        for (i = e; i = i.parentNode;) r.unshift(i);
                        for (i = t; i = i.parentNode;) a.unshift(i);
                        for (; r[n] === a[n];) n++;
                        return n ? he(r[n], a[n]) : r[n] == w ? -1 : a[n] == w ? 1 : 0
                    }), p
                }, ae.matches = function (e, t) {
                    return ae(e, null, null, t)
                }, ae.matchesSelector = function (e, t) {
                    if (h(e), i.matchesSelector && m && !j[t + " "] && (!v || !v.test(t)) && (!g || !g.test(t))) try {
                        var n = y.call(e, t);
                    ...
                    var s = n.attrHandle[t.toLowerCase()],
                        o = s && P.call(n.attrHandle, t.toLowerCase()) ? s(e, t, !m) : void 0;
                    ...
                    var t, n = [],
                        s = 0,
                        o = 0;
                    if (d = !i.detectDuplicates, c = !i.sortStable && e.slice(0), e.sort(x), d) {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (e) {
                            var t, i = !e[6] && e[2];
                            return Y.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : i && z.test(i) && (t = r(i, !0)) && (t = i.indexOf(")", i.length - t) - i.length) && (e[0] = e[0].slice(0, t), e[2] = i.slice(0, t)), e.slice(0, 3))
                        }
                    },
                    filter: {
                        TAG: function (e) {
                        ...
                        ATTR: function (e, t, i) {
                            return function (n) {
                                var s = ae.attr(n, e);
                                return null == s ? "!=" === t : !t || (s += "", "=" === t ? s === i : "!=" === t ? s !== i : "^=" === t ? i && 0 === s.indexOf(i) : "*=" === t ? i && -1 < s.indexOf(i) : "$=" === t ? i && s.slice(-i.length) === i : "~=" === t ? -1 < (" " + s.replace(F, " ") + " ").indexOf(i) : "|=" === t && (s === i || s.slice(0, i.length + 1) === i + "-"))
                            }
                        },
                            ...
                            return 1 === n && 0 === s ? function (e) {
                                ...
                                if (g) {
                                    ...
                                    if (f = [r ? g.firstChild : g.lastChild], r && y) {
                                        for (b = (p = (u = (c = (d = (h = g)[_] || (h[_] = {}))[h.uniqueID] || (d[h.uniqueID] = {}))[e] || [])[0] === T && u[1]) && u[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (b = p = 0) || f.pop();)
                                            if (1 === h.nodeType && ++b && h === t) {
                                                c[e] = [T, p, b];
                                                break
                                            }
                                    } else if (y && (b = p = (u = (c = (d = (h = t)[_] || (h[_] = {}))[h.uniqueID] || (d[h.uniqueID] = {}))[e] || [])[0] === T && u[1]), !1 === b)
                                        for (;
                                            (h = ++p && h && h[m] || (b = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++b || (y && ((c = (d = h[_] || (h[_] = {}))[h.uniqueID] || (d[h.uniqueID] = {}))[e] = [T, b]), h !== t)););
                        ...
                        PSEUDO: function (e, t) {
                            ...
                            return s[_] ? s(t) : 1 < s.length ? (i = [e, e, "", t], n.setFilters.hasOwnProperty(e.toLowerCase()) ? ue(function (e, i) {
                                for (var n, o = s(e, t), r = o.length; r--;) e[n = L(e, o[r])] = !(i[n] = o[r])
                            }) : function (e) {
                                return s(e, 0, i)
                            }) : s
                        }
                    ...
                    pseudos: {
                        not: ue(function (e) {
                            var t = [],
                                i = [],
                                n = a(e.replace(B, "$1"));
                            return n[_] ? ue(function (e, t, i, s) {
            ...
            function _e(e, t, i) {
                ...
                return t.first ? function (t, i, s) {
                    ...
                    if (l) {
                        ...
                        for (; t = t[n];)
                            if (1 === t.nodeType || r)
                                if (c = (d = t[_] || (t[_] = {}))[t.uniqueID] || (d[t.uniqueID] = {}), s && s === t.nodeName.toLowerCase()) t = t[n] || t;
                                else {
                                    if ((u = c[o]) && u[0] === T && u[1] === a) return h[2] = u[2];
                                    if ((c[o] = h)[2] = e(t, i, l)) return !0
                                } return !1
                }
            }
            ...
            function Te(e, t, i, n, s) {
                for (var o, r = [], a = 0, l = e.length, u = null != t; a < l; a++)(o = e[a]) && (i && !i(o, n, s) || (r.push(o), u && t.push(a)));
                return r
            }

            function Se(e, t, i, n, s, o) {
                return n && !n[_] && (n = Se(n)), s && !s[_] && (s = Se(s, o)), ue(function (o, r, a, l) {
                    var u, c, d, h = [],
                        p = [],
                        f = r.length,
                        m = o || function (e, t, i) {
                        ...
                        g = !e || !o && t ? m : Te(m, h, e, a, l),
                        v = i ? s || (o ? e : f || n) ? [] : r : g;
                    if (i && i(g, v, a, l), n)
                        for (u = Te(v, p), n(u, [], a, l), c = u.length; c--;)(d = u[c]) && (v[p[c]] = !(g[p[c]] = d));
                    if (o) {
                        if (s || e) {
                            if (s) {
                            ...
                            for (c = v.length; c--;)(d = v[c]) && -1 < (u = s ? L(o, d) : h[c]) && (o[u] = !(r[u] = d))
                        }
            ...
            function ke(e) {
                for (var t, i, s, o = e.length, r = n.relative[e[0].type], a = r || n.relative[" "], l = r ? 1 : 0, c = _e(function (e) {
                        return e === t
                    }, a, !0), d = _e(function (e) {
                        return -1 < L(t, e)
                    }, a, !0), h = [function (e, i, n) {
                        var s = !r && (n || i !== u) || ((t = i).nodeType ? c(e, i, n) : d(e, i, n));
                        return t = null, s
                    }]; l < o; l++)
                    if (i = n.relative[e[l].type]) h = [_e(we(h), i)];
                    else {
                        if ((i = n.filter[e[l].type].apply(null, e[l].matches))[_]) {
                            for (s = ++l; s < o && !n.relative[e[s].type]; s++);
                            return Se(1 < l && we(h), 1 < l && be(e.slice(0, l - 1).concat({
                                value: " " === e[l - 2].type ? "*" : ""
                            })).replace(B, "$1"), i, l < s && ke(e.slice(l, s)), s < o && ke(e = e.slice(s)), s < o && be(e))
                        }
                        h.push(i)
                    } return we(h)
            }
            return ye.prototype = n.filters = n.pseudos, n.setFilters = new ye, r = ae.tokenize = function (e, t) {
                var i, s, o, r, a, l, u, c = C[e + " "];
                if (c) return t ? 0 : c.slice(0);
                for (a = e, l = [], u = n.preFilter; a;) {
                    for (r in i && !(s = W.exec(a)) || (s && (a = a.slice(s[0].length) || a), l.push(o = [])), i = !1, (s = U.exec(a)) && (i = s.shift(), o.push({
                            value: i,
                            type: s[0].replace(B, " ")
                        }), a = a.slice(i.length)), n.filter) !(s = Y[r].exec(a)) || u[r] && !(s = u[r](s)) || (i = s.shift(), o.push({
                        value: i,
                        type: r,
                        matches: s
                    }), a = a.slice(i.length));
                ...
                var i, s, o, a, l, c, d = [],
                    ...
                    g = E[e + " "];
                if (!g) {
                    for (t || (t = r(e)), i = t.length; i--;)(g = ke(t[i]))[_] ? d.push(g) : f.push(g);
                    (g = E(e, (s = f, a = 0 < (o = d).length, l = 0 < s.length, c = function (e, t, i, r, c) {
                        var d, f, g, v = 0,
                            y = "0",
                            b = e && [],
                            _ = [],
                            ...
                            C = S.length;
                        for (c && (u = t == p || t || c); y !== C && null != (d = S[y]); y++) {
                            if (l && d) {
                                for (f = 0, t || d.ownerDocument == p || (h(d), i = !m); g = s[f++];)
                                    if (g(d, t || p, i)) {
                                        r.push(d);
                                        break
                                    } c && (T = k)
                        ...
                        if (v += y, a && y !== v) {
                            for (f = 0; g = o[f++];) g(b, _, t, i);
                            if (e) {
                                if (0 < v)
                                    for (; y--;) b[y] || _[y] || (_[y] = O.call(r));
                                _ = Te(_)
                            }
                            D.apply(r, _), c && !e && 0 < _.length && 1 < v + o.length && ae.uniqueSort(r)
                        }
                        return c && (T = k, u = w), b
                    }, a ? ue(c) : c))).selector = e
                }
                ...
                if (i = i || [], 1 === p.length) {
                    if (2 < (l = p[0] = p[0].slice(0)).length && "ID" === (u = l[0]).type && 9 === t.nodeType && m && n.relative[l[1].type]) {
                        if (!(t = (n.find.ID(u.matches[0].replace(te, ie), t) || [])[0])) return i;
                        h && (t = t.parentNode), e = e.slice(l.shift().value.length)
                    }
                    for (o = Y.needsContext.test(e) ? 0 : l.length; o-- && (u = l[o], !n.relative[c = u.type]);)
                        if ((d = n.find[c]) && (s = d(u.matches[0].replace(te, ie), ee.test(l[0].type) && ve(t.parentNode) || t))) {
                            if (l.splice(o, 1), !(e = s.length && be(l))) return D.apply(i, s), i;
                            break
                        }
                }
                return (h || a(e, p))(s, t, !m, i, !t || ee.test(e) && ve(t.parentNode) || t), i
            }, i.sortStable = _.split("").sort(x).join("") === _, i.detectDuplicates = !!d, h(), i.sortDetached = ce(function (e) {
        ...
        (w.fn.init = function (e, t, i) {
            ...
            if (i = i || A, "string" == typeof e) {
                ...
                if (n[1]) {
                    if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : g, !0)), x.test(n[1]) && w.isPlainObject(t))
        ...
        w.fn.extend({
            ...
            contents: function (e) {
                return null != e.contentDocument && n(e.contentDocument) ? e.contentDocument : (j(e, "template") && (e = e.content || e), w.merge([], e.childNodes))
            }
        }, function (e, t) {
            w.fn[e] = function (i, n) {
                var s = w.map(this, t, i);
                return "Until" !== e.slice(-5) && (n = i), n && "string" == typeof n && (s = w.filter(n, s)), 1 < this.length && (D[e] || w.uniqueSort(s), N.test(e) && s.reverse()), this.pushStack(s)
            }
        });
        var L = /[^\x20\t\r\n\f]+/g;
        ...
        w.Callbacks = function (e) {
            var t, i;
            e = "string" == typeof e ? (t = e, i = {}, w.each(t.match(L) || [], function (e, t) {
                i[t] = !0
            }), i) : w.extend({}, e);
            var n, s, o, r, a = [],
                l = [],
                u = -1,
                c = function () {
                    for (r = r || e.once, o = n = !0; l.length; u = -1)
                        for (s = l.shift(); ++u < a.length;) !1 === a[u].apply(s[0], s[1]) && e.stopOnFalse && (u = a.length, s = !1);
                    e.memory || (s = !1), n = !1, r && (a = s ? [] : "")
                },
                d = {
                    add: function () {
                        return a && (s && !n && (u = a.length - 1, l.push(s)), function t(i) {
                    ...
                    remove: function () {
                        return w.each(arguments, function (e, t) {
                            for (var i; - 1 < (i = w.inArray(t, a, i));) a.splice(i, 1), i <= u && u--
                        }), this
                    },
                    has: function (e) {
                    ...
                    s = {
                        ...
                        then: function (t, n, s) {
                                    ...
                                    var a = this,
                                        ...
                                        u = function () {
                                            ...
                                            if (!(t < o)) {
                                                ...
                                                u = e && ("object" == typeof e || "function" == typeof e) && e.then, f(u) ? s ? u.call(e, r(o, i, q, s), r(o, i, R, s)) : (o++, u.call(e, r(o, i, q, s), r(o, i, R, s), r(o, i, q, i.notifyWith))) : (n !== q && (a = void 0, l = [e]), (s || i.resolveWith)(a, l))
                                            }
                                        },
                                        c = s ? u : function () {
                                            try {
                                                ...
                                                w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, c.stackTrace), o <= t + 1 && (n !== R && (a = void 0, l = [e]), i.rejectWith(a, l))
                                            }
                                        };
                            ...
                            return w.Deferred(function (e) {
                                i[0][3].add(r(0, e, f(s) ? s : q, e.notifyWith)), i[1][3].add(r(0, e, f(t) ? t : q)), i[2][3].add(r(0, e, f(n) ? n : R))
                            }).promise()
                        },
                        promise: function (e) {
            ...
            when: function (e) {
                ...
                if (t <= 1 && ($(e, r.done(a(i)).resolve, r.reject, !t), "pending" === r.state() || f(o[i] && o[i].then))) return r.then();
                for (; i--;) $(o[i], a(i), r.reject);
                return r.promise()
            }
        });
        ...
        }), w.ready.then = H.then, "complete" === g.readyState || "loading" !== g.readyState && !g.documentElement.doScroll ? e.setTimeout(w.ready) : (g.addEventListener("DOMContentLoaded", F), e.addEventListener("load", F));
        var B = function (e, t, i, n, s, o, r) {
                var a = 0,
                    l = e.length,
                    u = null == i;
                if ("object" === b(i))
                    for (a in s = !0, i) B(e, t, a, i[a], !0, o, r);
                else if (void 0 !== n && (s = !0, f(n) || (r = !0), u && (r ? (t.call(e, n), t = null) : (u = t, t = function (e, t, i) {
                        return u.call(w(e), i)
                    })), t))
                    for (; a < l; a++) t(e[a], i, r ? n : n.call(e[a], a, t(e[a], i)));
                return s ? e : u ? t.call(e) : l ? t(e[0], i) : o
            },
            W = /^-ms-/,
            U = /-([a-z])/g;
        ...
        Y.uid = 1, Y.prototype = {
            ...
            set: function (e, t, i) {
                ...
                if ("string" == typeof t) s[z(t)] = i;
                else
                    for (n in t) s[z(n)] = t[n];
                return s
            },
            get: function (e, t) {
            ...
            remove: function (e, t) {
                ...
                if (void 0 !== n) {
                    if (void 0 !== t) {
                        i = (t = Array.isArray(t) ? t.map(z) : (t = z(t)) in n ? [t] : t.match(L) || []).length;
                        for (; i--;) delete n[t[i]]
        ...
        w.extend({
            ...
            data: function (e, t) {
                var i, n, s, o = this[0],
                    r = o && o.attributes;
                if (void 0 === e) {
                    if (this.length && (s = X.get(o), 1 === o.nodeType && !G.get(o, "hasDataAttrs"))) {
                        for (i = r.length; i--;) r[i] && 0 === (n = r[i].name).indexOf("data-") && (n = z(n.slice(5)), Z(o, n, s[n]));
                ...
                return "object" == typeof e ? this.each(function () {
                    ...
                    var i;
                    if (o && void 0 === t) return void 0 !== (i = X.get(o, e)) ? i : void 0 !== (i = Z(o, e)) ? i : void 0;
                    this.each(function () {
                        X.set(this, e, t)
                    })
            ...
            promise: function (e, t) {
                ...
                for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; r--;)(i = G.get(o[r], e + "queueHooks")) && i.empty && (n++, i.empty.add(a));
        ...
        function ae(e, t, i, n) {
            ...
            if (c && c[3] !== u) {
                for (l /= 2, u = u || c[3], c = +l || 1; r--;) w.style(e, t, c + u), (1 - o) * (1 - (o = a() / l || .5)) <= 0 && (r = 0), c /= o;
        ...
        function ue(e, t) {
            for (var i, n, s, o, r, a, l, u = [], c = 0, d = e.length; c < d; c++)(n = e[c]).style && (i = n.style.display, t ? ("none" === i && (u[c] = G.get(n, "display") || null, u[c] || (n.style.display = "")), "" === n.style.display && re(n) && (u[c] = (l = r = o = void 0, r = (s = n).ownerDocument, a = s.nodeName, (l = le[a]) || (o = r.body.appendChild(r.createElement(a)), l = w.css(o, "display"), o.parentNode.removeChild(o), "none" === l && (l = "block"), le[a] = l)))) : "none" !== i && (u[c] = "none", G.set(n, "display", i)));
        ...
        function ge(e, t) {
            var i;
            return i = void 0 !== e.getElementsByTagName ? e.getElementsByTagName(t || "*") : void 0 !== e.querySelectorAll ? e.querySelectorAll(t || "*") : [], void 0 === t || t && j(e, t) ? w.merge([e], i) : i
        }
        ...
        function be(e, t, i, n, s) {
            for (var o, r, a, l, u, c, d = t.createDocumentFragment(), h = [], p = 0, f = e.length; p < f; p++)
                if ((o = e[p]) || 0 === o)
                    if ("object" === b(o)) w.merge(h, o.nodeType ? [o] : o);
                    else if (ye.test(o)) {
                for (r = r || d.appendChild(t.createElement("div")), a = (pe.exec(o) || ["", ""])[1].toLowerCase(), l = me[a] || me._default, r.innerHTML = l[1] + w.htmlPrefilter(o) + l[2], c = l[0]; c--;) r = r.lastChild;
                w.merge(h, r.childNodes), (r = d.firstChild).textContent = ""
            } else h.push(t.createTextNode(o));
            for (d.textContent = "", p = 0; o = h[p++];)
                if (n && -1 < w.inArray(o, n)) s && s.push(o);
                else if (u = se(o), r = ge(d.appendChild(o), "script"), u && ve(r), i)
                for (c = 0; o = r[c++];) fe.test(o.type || "") && i.push(o);
            return d
        }
        var _e = /^key/,
        ...
        function Ee(e, t, i, n, s, o) {
            var r, a;
            if ("object" == typeof t) {
                for (a in "string" != typeof i && (n = n || i, i = void 0), t) Ee(e, a, i, n, t[a], o);
                return e
            }
        ...
        w.event = {
            ...
            add: function (e, t, i, n, s) {
                var o, r, a, l, u, c, d, h, p, f, m, g = G.get(e);
                if (Q(e))
                    for (i.handler && (i = (o = i).handler, s = o.selector), s && w.find.matchesSelector(ne, s), i.guid || (i.guid = w.guid++), (l = g.events) || (l = g.events = Object.create(null)), (r = g.handle) || (r = g.handle = function (t) {
                            return void 0 !== w && w.event.triggered !== t.type ? w.event.dispatch.apply(e, arguments) : void 0
                        }), u = (t = (t || "").match(L) || [""]).length; u--;) p = m = (a = Te.exec(t[u]) || [])[1], f = (a[2] || "").split(".").sort(), p && (d = w.event.special[p] || {}, p = (s ? d.delegateType : d.bindType) || p, d = w.event.special[p] || {}, c = w.extend({
                        type: p,
                        origType: m,
                        data: n,
                        handler: i,
                        ...
                        namespace: f.join(".")
                    }, o), (h = l[p]) || ((h = l[p] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, n, f, r) || e.addEventListener && e.addEventListener(p, r)), d.add && (d.add.call(e, c), c.handler.guid || (c.handler.guid = i.guid)), s ? h.splice(h.delegateCount++, 0, c) : h.push(c), w.event.global[p] = !0)
            },
            remove: function (e, t, i, n, s) {
                var o, r, a, l, u, c, d, h, p, f, m, g = G.hasData(e) && G.get(e);
                if (g && (l = g.events)) {
                    for (u = (t = (t || "").match(L) || [""]).length; u--;)
                        if (p = m = (a = Te.exec(t[u]) || [])[1], f = (a[2] || "").split(".").sort(), p) {
                            for (d = w.event.special[p] || {}, h = l[p = (n ? d.delegateType : d.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = o = h.length; o--;) c = h[o], !s && m !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (h.splice(o, 1), c.selector && h.delegateCount--, d.remove && d.remove.call(e, c));
            ...
            dispatch: function (e) {
                ...
                if (l.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, l)) {
                    for (r = w.event.handlers.call(this, l, u), t = 0;
                ...
                if (l && u.nodeType && !("click" === e.type && 1 <= e.button))
                    for (; u !== this; u = u.parentNode || this)
                        if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                            for (o = [], r = {}, i = 0; i < l; i++) void 0 === r[s = (n = t[i]).selector + " "] && (r[s] = n.needsContext ? -1 < w(s, this).index(u) : w.find(s, this, null, [u]).length), r[s] && o.push(n);
                            o.length && a.push({
                                elem: u,
                                handlers: o
                            })
            ...
            special: {
                ...
                click: {
                    setup: function (e) {
                        var t = this || e;
                        return he.test(t.type) && t.click && j(t, "input") && je(t, "click", Se), !1
                    },
                    trigger: function (e) {
                        var t = this || e;
                        return he.test(t.type) && t.click && j(t, "input") && je(t, "click"), !0
                    },
                    _default: function (e) {
                        var t = e.target;
                        return he.test(t.type) && t.click && j(t, "input") && G.get(t, "click") || j(t, "a")
                    }
                },
                beforeunload: {
        ...
        function Ie(e, t) {
            ...
            if (1 === t.nodeType) {
                if (G.hasData(e) && (a = G.get(e).events))
                    for (s in G.remove(t, "handle events"), a)
        ...
        function Le(e, t, i, n) {
            ...
            var s, r, a, l, u, c, d = 0,
                ...
                g = t[0],
                v = f(g);
            if (v || 1 < h && "string" == typeof g && !p.checkClone && Pe.test(g)) return e.each(function (s) {
                var o = e.eq(s);
                v && (t[0] = g.call(this, s, o.html())), Le(o, t, i, n)
            });
            if (h && (r = (s = be(t, e[0].ownerDocument, !1, e, n)).firstChild, 1 === s.childNodes.length && (s = r), r || n)) {
                for (l = (a = w.map(ge(s, "script"), Ne)).length; d < h; d++) u = s, d !== m && (u = w.clone(u, !0, !0), l && w.merge(a, ge(u, "script"))), i.call(e[d], u, d);
                if (l)
                    for (c = a[a.length - 1].ownerDocument, w.map(a, De), d = 0; d < l; d++) u = a[d], fe.test(u.type || "") && !G.access(u, "globalEval") && w.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? w._evalUrl && !u.noModule && w._evalUrl(u.src, {
        ...
        function qe(e, t, i) {
            for (var n, s = t ? w.filter(t, e) : e, o = 0; null != (n = s[o]); o++) i || 1 !== n.nodeType || w.cleanData(ge(n)), n.parentNode && (i && se(n) && ve(ge(n, "script")), n.parentNode.removeChild(n));
            return e
        }
        w.extend({
            ...
            clone: function (e, t, i) {
                var n, s, o, r, a, l, u, c = e.cloneNode(!0),
                    d = se(e);
                if (!(p.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
                    for (r = ge(c), n = 0, s = (o = ge(e)).length; n < s; n++) a = o[n], "input" === (u = (l = r[n]).nodeName.toLowerCase()) && he.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
                if (t)
                    if (i)
                        for (o = o || ge(e), r = r || ge(c), n = 0, s = o.length; n < s; n++) Ie(o[n], r[n]);
                    else Ie(e, c);
                return 0 < (r = ge(c, "script")).length && ve(r, !d && ge(e, "script")), c
            },
            cleanData: function (e) {
                for (var t, i, n, s = w.event.special, o = 0; void 0 !== (i = e[o]); o++)
                    if (Q(i)) {
                        if (t = i[G.expando]) {
                            if (t.events)
            ...
            w.fn[e] = function (e) {
                for (var i, n = [], s = w(e), o = s.length - 1, a = 0; a <= o; a++) i = a === o ? this : this.clone(!0), w(s[a])[t](i), r.apply(n, i.get());
        ...
        function Fe(e, t, i) {
            ...
            return (i = i || $e(e)) && ("" !== (r = i.getPropertyValue(t) || i[t]) || se(e) || (r = w.style(e, t)), !p.pixelBoxStyles() && Re.test(r) && He.test(t) && (n = a.width, s = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = i.width, a.width = n, a.minWidth = s, a.maxWidth = o)), void 0 !== r ? r + "" : r
        }
        ...
        function Be(e, t) {
            ...
            function t() {
                if (c) {
                    u.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", c.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", ne.appendChild(u).appendChild(c);
                    var t = e.getComputedStyle(c);
                    n = "1%" !== t.top, l = 12 === i(t.marginLeft), c.style.right = "60%", r = 36 === i(t.right), s = 36 === i(t.width), c.style.position = "absolute", o = 12 === i(c.offsetWidth / 3), ne.removeChild(u), c = null
                }
            }
            ...
            var n, s, o, r, a, l, u = g.createElement("div"),
            ...
            c.style && (c.style.backgroundClip = "content-box", c.cloneNode(!0).style.backgroundClip = "", p.clearCloneStyle = "content-box" === c.style.backgroundClip, w.extend(p, {
                ...
                reliableTrDimensions: function () {
                    var t, i, n, s;
                    return null == a && (t = g.createElement("table"), i = g.createElement("tr"), n = g.createElement("div"), t.style.cssText = "position:absolute;left:-11111px", i.style.height = "1px", n.style.height = "9px", ne.appendChild(t).appendChild(i).appendChild(n), s = e.getComputedStyle(i), a = 3 < parseInt(s.height), ne.removeChild(t)), a
                }
            }))
        }();
        ...
        function Je(e, t, i, n, s, o) {
            var r = "width" === t ? 1 : 0,
                a = 0,
                l = 0;
            if (i === (n ? "border" : "content")) return 0;
            for (; r < 4; r += 2) "margin" === i && (l += w.css(e, i + ie[r], !0, s)), n ? ("content" === i && (l -= w.css(e, "padding" + ie[r], !0, s)), "margin" !== i && (l -= w.css(e, "border" + ie[r] + "Width", !0, s))) : (l += w.css(e, "padding" + ie[r], !0, s), "padding" !== i ? l += w.css(e, "border" + ie[r] + "Width", !0, s) : a += w.css(e, "border" + ie[r] + "Width", !0, s));
            return !n && 0 <= o && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - o - l - a - .5)) || 0), l
        }
        ...
        function Ze(e, t, i) {
            ...
            return (!p.boxSizingReliable() && s || !p.reliableTrDimensions() && j(e, "tr") || "auto" === r || !parseFloat(r) && "inline" === w.css(e, "display", !1, n)) && e.getClientRects().length && (s = "border-box" === w.css(e, "boxSizing", !1, n), (o = a in e) && (r = e[a])), (r = parseFloat(r) || 0) + Je(e, t, i || (s ? "border" : "content"), o, n, r) + "px"
        }
        ...
        w.extend({
            ...
            style: function (e, t, i, n) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var s, o, r, a = z(t),
                        l = Ye.test(t),
                        u = e.style;
                    if (l || (t = ze(a)), r = w.cssHooks[t] || w.cssHooks[a], void 0 === i) return r && "get" in r && void 0 !== (s = r.get(e, !1, n)) ? s : u[t];
                    "string" == (o = typeof i) && (s = te.exec(i)) && s[1] && (i = ae(e, t, s), o = "number"), null != i && i == i && ("number" !== o || l || (i += s && s[3] || (w.cssNumber[a] ? "" : "px")), p.clearCloneStyle || "" !== i || 0 !== t.indexOf("background") || (u[t] = "inherit"), r && "set" in r && void 0 === (i = r.set(e, i, n)) || (l ? u.setProperty(t, i) : u[t] = i))
                }
            },
            css: function (e, t, i, n) {
                var s, o, r, a = z(t);
                return Ye.test(t) || (t = ze(a)), (r = w.cssHooks[t] || w.cssHooks[a]) && "get" in r && (s = r.get(e, !0, i)), void 0 === s && (s = Fe(e, t, n)), "normal" === s && t in Xe && (s = Xe[t]), "" === i || i ? (o = parseFloat(s), !0 === i || isFinite(o) ? o || 0 : s) : s
            }
        }), w.each(["height", "width"], function (e, t) {
            w.cssHooks[t] = {
                get: function (e, i, n) {
                    if (i) return !Qe.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ze(e, t, n) : Me(e, Ge, function () {
                        return Ze(e, t, n)
                    })
                },
                set: function (e, i, n) {
                    var s, o = $e(e),
                        ...
                        a = (r || n) && "border-box" === w.css(e, "boxSizing", !1, o),
                        l = n ? Je(e, t, n, a, o) : 0;
                    return a && r && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Je(e, t, "border", !1, o) - .5)), l && (s = te.exec(i)) && "px" !== (s[3] || "px") && (e.style[t] = i, i = w.css(e, t)), Ke(0, i, l)
                }
            }
            ...
            w.cssHooks[e + t] = {
                expand: function (i) {
                    for (var n = 0, s = {}, o = "string" == typeof i ? i.split(" ") : [i]; n < 4; n++) s[e + ie[n] + t] = o[n] || o[n - 2] || o[0];
                    return s
                }
            ...
            css: function (e, t) {
                return B(this, function (e, t, i) {
                    var n, s, o = {},
                        r = 0;
                    if (Array.isArray(t)) {
                        for (n = $e(e), s = t.length; r < s; r++) o[t[r]] = w.css(e, t[r], !1, n);
                        return o
                    }
            ...
            init: function (e, t, i, n, s, o) {
                this.elem = e, this.prop = i, this.easing = s || w.easing._default, this.options = t, this.start = this.now = this.cur(), this.end = n, this.unit = o || (w.cssNumber[i] ? "" : "px")
            },
            cur: function () {
        ...
        var tt, it, nt, st, ot = /^(?:toggle|show|hide)$/,
            rt = /queueHooks$/;

        function at() {
            it && (!1 === g.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(at) : e.setTimeout(at, w.fx.interval), w.fx.tick())
        }
        ...
        function ct(e, t, i) {
            for (var n, s = (dt.tweeners[t] || []).concat(dt.tweeners["*"]), o = 0, r = s.length; o < r; o++)
        ...
        function dt(e, t, i) {
            var n, s, o = 0,
                ...
                l = function () {
                    if (s) return !1;
                    for (var t = tt || lt(), i = Math.max(0, u.startTime + u.duration - t), n = 1 - (i / u.duration || 0), o = 0, r = u.tweens.length; o < r; o++) u.tweens[o].run(n);
            ...
            for (function (e, t) {
                    var i, n, s, o, r;
                    for (i in e)
                        if (s = t[n = z(i)], o = e[i], Array.isArray(o) && (s = o[1], o = e[i] = o[0]), i !== n && (e[n] = o, delete e[i]), (r = w.cssHooks[n]) && "expand" in r)
                            for (i in o = r.expand(o), delete e[n], o) i in e || (e[i] = o[i], t[i] = s);
                        else t[n] = s
                }(c, u.opts.specialEasing); o < r; o++)
                if (n = dt.prefilters[o].call(u, e, c, u.opts)) return f(n.stop) && (w._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)), n;
            return w.map(c, ct, u), f(u.opts.start) && u.opts.start.call(e, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), w.fx.timer(w.extend(l, {
                elem: e,
                anim: u,
                queue: u.opts.queue
            })), u
        ...
        w.Animation = w.extend(dt, {
            ...
            prefilters: [function (e, t, i) {
                ...
                for (n in i.queue || (null == (r = w._queueHooks(e, "fx")).unqueued && (r.unqueued = 0, a = r.empty.fire, r.empty.fire = function () {
                    ...
                    for (n in d && 1 === e.nodeType && (i.overflow = [f.overflow, f.overflowX, f.overflowY], null == (u = g && g.display) && (u = G.get(e, "display")), "none" === (c = w.css(e, "display")) && (u ? c = u : (ue([e], !0), u = e.style.display || u, c = w.css(e, "display"), ue([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === w.css(e, "float") && (l || (h.done(function () {
                            f.display = u
                        ...
                        display: u
                    }), o && (g.hidden = !m), m && ue([e], !0), h.done(function () {
            ...
            finish: function (e) {
                return !1 !== e && (e = e || "fx"), this.each(function () {
                    var t, i = G.get(this),
                        ...
                        o = w.timers,
                        r = n ? n.length : 0;
                    for (i.finish = !0, w.queue(this, e, []), s && s.stop && s.stop.call(this, !0), t = o.length; t--;) o[t].elem === this && o[t].queue === e && (o[t].anim.stop(!0), o.splice(t, 1));
        ...
        }, nt = g.createElement("input"), st = g.createElement("select").appendChild(g.createElement("option")), nt.type = "checkbox", p.checkOn = "" !== nt.value, p.optSelected = st.selected, (nt = g.createElement("input")).value = "t", nt.type = "radio", p.radioValue = "t" === nt.value;
        ...
        w.fn.extend({
            ...
            attr: function (e, t, i) {
                ...
                if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? w.prop(e, t, i) : (1 === o && w.isXMLDoc(e) || (s = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? ht : void 0)), void 0 !== i ? null === i ? void w.removeAttr(e, t) : s && "set" in s && void 0 !== (n = s.set(e, i, t)) ? n : (e.setAttribute(t, i + ""), i) : s && "get" in s && null !== (n = s.get(e, t)) ? n : null == (n = w.find.attr(e, t)) ? void 0 : n)
            },
            attrHooks: {
                type: {
                    set: function (e, t) {
            ...
            pt[t] = function (e, t, n) {
                ...
                return n || (o = pt[r], pt[r] = s, s = null != i(e, t, n) ? r : null, pt[r] = o), s
            }
        });
        ...
        w.fn.extend({
            ...
            prop: function (e, t, i) {
                var n, s, o = e.nodeType;
                if (3 !== o && 8 !== o && 2 !== o) return 1 === o && w.isXMLDoc(e) || (t = w.propFix[t] || t, s = w.propHooks[t]), void 0 !== i ? s && "set" in s && void 0 !== (n = s.set(e, i, t)) ? n : e[t] = i : s && "get" in s && null !== (n = s.get(e, t)) ? n : e[t]
            },
            propHooks: {
                tabIndex: {
                    get: function (e) {
            ...
            toggleClass: function (e, t) {
                ...
                return "boolean" == typeof t && n ? t ? this.addClass(e) : this.removeClass(e) : f(e) ? this.each(function (i) {
                    ...
                    else void 0 !== e && "boolean" !== i || ((t = vt(this)) && G.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : G.get(this, "__className__") || ""))
                })
            },
            hasClass: function (e) {
                var t, i, n = 0;
                ...
                select: {
                    get: function (e) {
                        ...
                        for (n = o < 0 ? l : r ? o : 0; n < l; n++)
                            if (((i = s[n]).selected || n === o) && !i.disabled && (!i.parentNode.disabled || !j(i.parentNode, "optgroup"))) {
                                if (t = w(i).val(), r) return t;
                                a.push(t)
                            } return a
                    },
                    set: function (e, t) {
                        for (var i, n, s = e.options, o = w.makeArray(t), r = s.length; r--;)((n = s[r]).selected = -1 < w.inArray(w.valHooks.option.get(n), o)) && (i = !0);
        ...
        w.extend(w.event, {
            trigger: function (t, i, n, s) {
                ...
                if (r = p = a = n = n || g, 3 !== n.nodeType && 8 !== n.nodeType && !_t.test(y + w.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(), b.sort()), u = y.indexOf(":") < 0 && "on" + y, (t = t[w.expando] ? t : new w.Event(y, "object" == typeof t && t)).isTrigger = s ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), i = null == i ? [t] : w.makeArray(i, [t]), h = w.event.special[y] || {}, s || !h.trigger || !1 !== h.trigger.apply(n, i))) {
                    ...
                    for (o = 0;
                        (r = v[o++]) && !t.isPropagationStopped();) p = r, t.type = 1 < o ? l : h.bindType || y, (d = (G.get(r, "events") || Object.create(null))[t.type] && G.get(r, "handle")) && d.apply(r, i), (d = u && r[u]) && d.apply && Q(r) && (t.result = d.apply(r, i), !1 === t.result && t.preventDefault());
                    return t.type = y, s || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(v.pop(), i) || !Q(n) || u && f(n[y]) && !m(n) && ((a = n[u]) && (n[u] = null), w.event.triggered = y, t.isPropagationStopped() && p.addEventListener(y, wt), n[y](), t.isPropagationStopped() && p.removeEventListener(y, wt), w.event.triggered = void 0, a && (n[u] = a)), t.result
                }
            },
            ...
            w.event.special[t] = {
                setup: function () {
                    var n = this.ownerDocument || this.document || this,
                        s = G.access(n, t);
                    s || n.addEventListener(e, i, !0), G.access(n, t, (s || 0) + 1)
                },
                teardown: function () {
                    var n = this.ownerDocument || this.document || this,
                        s = G.access(n, t) - 1;
                    s ? G.access(n, t, s) : (n.removeEventListener(e, i, !0), G.remove(n, t))
                }
            }
        });
        var Tt = e.location,
        ...
        function Pt(e, t, i, n) {
            ...
            if (Array.isArray(t)) w.each(t, function (t, s) {
                i || Ct.test(e) ? n(e, s) : Pt(e + "[" + ("object" == typeof s && null != s ? t : "") + "]", s, i, n)
            });
        ...
        w.param = function (e, t) {
            ...
            serializeArray: function () {
                return this.map(function () {
                    ...
                    var e = this.type;
                    return this.name && !w(this).is(":disabled") && xt.test(this.nodeName) && !jt.test(e) && (this.checked || !he.test(e))
                }).map(function (e, t) {
                    var i = w(this).val();
        ...
        Mt.href = Tt.href, w.extend({
            ...
            ajax: function (t, i) {
                ...
                var n, s, o, r, a, l, u, c, d, h, p = w.ajaxSetup({}, i),
                    f = p.context || p,
                    ...
                    k = {
                        ...
                        getResponseHeader: function (e) {
                            ...
                            if (u) {
                                if (!r)
                                    for (r = {}; t = Dt.exec(o);) r[t[1].toLowerCase() + " "] = (r[t[1].toLowerCase() + " "] || []).concat(t[2]);
                                t = r[e.toLowerCase() + " "]
                            }
                ...
                if (v.promise(k), p.url = ((t || p.url || Tt.href) + "").replace(Lt, Tt.protocol + "//"), p.type = i.method || i.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(L) || [""], null == p.crossDomain) {
                    l = g.createElement("a");
                    try {
                ...
                if (p.data && p.processData && "string" != typeof p.data && (p.data = w.param(p.data, p.traditional)), Ft(qt, p, i, k), u) return k;
                for (d in (c = w.event && p.global) && 0 == w.active++ && w.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !It.test(p.type), s = p.url.replace(Ot, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(At, "+")) : (h = p.url.slice(s.length), p.data && (p.processData || "string" == typeof p.data) && (s += (kt.test(s) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (s = s.replace(Nt, "$1"), h = (kt.test(s) ? "&" : "?") + "_=" + St.guid++ + h), p.url = s + h), p.ifModified && (w.lastModified[s] && k.setRequestHeader("If-Modified-Since", w.lastModified[s]), w.etag[s] && k.setRequestHeader("If-None-Match", w.etag[s])), (p.data && p.hasContent && !1 !== p.contentType || i.contentType) && k.setRequestHeader("Content-Type", p.contentType), k.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + $t + "; q=0.01" : "") : p.accepts["*"]), p.headers) k.setRequestHeader(d, p.headers[d]);
                if (p.beforeSend && (!1 === p.beforeSend.call(f, k, p) || u)) return k.abort();
                if (S = "abort", y.add(p.complete), k.done(p.success), k.fail(p.error), n = Ft(Rt, p, i, k)) {
                ...
                function C(t, i, r, l) {
                    var d, h, g, _, T, S = i;
                    u || (u = !0, a && e.clearTimeout(a), n = void 0, o = l || "", k.readyState = 0 < t ? 4 : 0, d = 200 <= t && t < 300 || 304 === t, r && (_ = function (e, t, i) {
                    ...
                    }(p, k, r)), !d && -1 < w.inArray("script", p.dataTypes) && (p.converters["text script"] = function () {}), _ = function (e, t, i, n) {
                        var s, o, r, a, l, u = {},
                            c = e.dataTypes.slice();
                        if (c[1])
                    ...
                    }(p, _, k, d), d ? (p.ifModified && ((T = k.getResponseHeader("Last-Modified")) && (w.lastModified[s] = T), (T = k.getResponseHeader("etag")) && (w.etag[s] = T)), 204 === t || "HEAD" === p.type ? S = "nocontent" : 304 === t ? S = "notmodified" : (S = _.state, h = _.data, d = !(g = _.error))) : (g = S, !t && S || (S = "error", t < 0 && (t = 0))), k.status = t, k.statusText = (i || S) + "", d ? v.resolveWith(f, [h, S, k]) : v.rejectWith(f, [k, S, g]), k.statusCode(b), b = void 0, c && m.trigger(d ? "ajaxSuccess" : "ajaxError", [k, p, d ? h : g]), y.fireWith(f, [k, S]), c && (m.trigger("ajaxComplete", [k, p]), --w.active || w.event.trigger("ajaxStop")))
                }
                return k
            },
        ...
        p.cors = !!Ut && "withCredentials" in Ut, p.ajax = Ut = !!Ut, w.ajaxTransport(function (t) {
            ...
            if (p.cors || Ut && !t.crossDomain) return {
                send: function (s, o) {
                    ...
                    i = function (e) {
                        return function () {
                            i && (i = n = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Wt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                binary: a.response
                            } : {
                                text: a.responseText
        ...
        w.ajaxSetup({
            ...
            jsonpCallback: function () {
                var e = zt.pop() || w.expando + "_" + St.guid++;
                return this[e] = !0, e
            }
        }), w.ajaxPrefilter("json jsonp", function (t, i, n) {
            var s, o, r, a = !1 !== t.jsonp && (Qt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Qt.test(t.data) && "data");
            if (a || "jsonp" === t.dataTypes[0]) return s = t.jsonpCallback = f(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Qt, "$1" + s) : !1 !== t.jsonp && (t.url += (kt.test(t.url) ? "&" : "?") + t.jsonp + "=" + s), t.converters["script json"] = function () {
                return r || w.error(s + " was not called"), r[0]
            }, t.dataTypes[0] = "json", o = e[s], e[s] = function () {
                r = arguments
            }, n.always(function () {
                void 0 === o ? w(e).removeProp(s) : e[s] = o, t[s] && (t.jsonpCallback = i.jsonpCallback, zt.push(s)), r && f(o) && o(r[0]), r = o = void 0
            }), "script"
        }), p.createHTMLDocument = ((Vt = g.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Vt.childNodes.length), w.parseHTML = function (e, t, i) {
            return "string" != typeof e ? [] : ("boolean" == typeof t && (i = t, t = !1), t || (p.createHTMLDocument ? ((n = (t = g.implementation.createHTMLDocument("")).createElement("base")).href = g.location.href, t.head.appendChild(n)) : t = g), o = !i && [], (s = x.exec(e)) ? [t.createElement(s[1])] : (s = be([e], t, o), o && o.length && w(o).remove(), w.merge([], s.childNodes)));
            var n, s, o
        }, w.fn.load = function (e, t, i) {
            var n, s, o, r = this,
                a = e.indexOf(" ");
            return -1 < a && (n = gt(e.slice(a)), e = e.slice(0, a)), f(t) ? (i = t, t = void 0) : t && "object" == typeof t && (s = "POST"), 0 < r.length && w.ajax({
                url: e,
                type: s || "GET",
                dataType: "html",
                data: t
            }).done(function (e) {
                o = arguments, r.html(n ? w("<div>").append(w.parseHTML(e)).find(n) : e)
            ...
            setOffset: function (e, t, i) {
                var n, s, o, r, a, l, u = w.css(e, "position"),
                    c = w(e),
                    d = {};
                "static" === u && (e.style.position = "relative"), a = c.offset(), o = w.css(e, "top"), l = w.css(e, "left"), ("absolute" === u || "fixed" === u) && -1 < (o + l).indexOf("auto") ? (r = (n = c.position()).top, s = n.left) : (r = parseFloat(o) || 0, s = parseFloat(l) || 0), f(t) && (t = t.call(e, i, w.extend({}, a))), null != t.top && (d.top = t.top - a.top + r), null != t.left && (d.left = t.left - a.left + s), "using" in t ? t.using.call(e, d) : ("number" == typeof d.top && (d.top += "px"), "number" == typeof d.left && (d.left += "px"), c.css(d))
            }
        }, w.fn.extend({
            offset: function (e) {
            ...
            w.cssHooks[t] = Be(p.pixelPosition, function (e, i) {
            ...
            w.each({
                ...
                w.fn[n] = function (s, o) {
                    ...
                    return B(this, function (t, i, s) {
                        var o;
                        return m(t) ? 0 === n.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (o = t.documentElement, Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === s ? w.css(t, i, a) : w.style(t, i, s, a)
                    }, t, r ? s : void 0, r)
                }
            })
        ...
        w.proxy = function (e, t) {
            var i, n, o;
            if ("string" == typeof t && (i = e[t], t = e, e = i), f(e)) return n = s.call(arguments, 2), (o = function () {
                return e.apply(t || this, n.concat(s.call(arguments)))
            }).guid = e.guid = e.guid || w.guid++, o
        }, w.holdReady = function (e) {
            e ? w.readyWait++ : w.ready(!0)
        }, w.isArray = Array.isArray, w.parseJSON = JSON.parse, w.nodeName = j, w.isFunction = f, w.isWindow = m, w.camelCase = z, w.type = b, w.now = Date.now, w.isNumeric = function (e) {
            var t = w.type(e);
        ...
        function s(e) {
            var i = e && e.offsetParent,
                n = i && i.nodeName;
            return n && "BODY" !== n && "HTML" !== n ? -1 !== ["TD", "TABLE"].indexOf(i.nodeName) && "static" === t(i, "position") ? s(i) : i : window.document.documentElement
        }
        ...
        function c(e, t, i, n) {
            return R(t["offset" + e], i["client" + e], i["offset" + e], V() ? i["offset" + e] + n["margin" + ("Height" === e ? "Top" : "Left")] + n["margin" + ("Height" === e ? "Bottom" : "Right")] : 0)
        }
        ...
        function p(e) {
            ...
            if (p || f) {
                var m = t(e);
                p -= u(m, "x"), f -= u(m, "y"), o.width -= p, o.height -= f
            }
            return h(o)
        }
        ...
        function f(e, i) {
            ...
            return (s ? i.contains(u) : i === u && "BODY" !== u.nodeName) && (m = l(m, i)), m
        }

        function m(e) {
            var t = window.document.documentElement,
                i = f(e, t),
                n = R(t.clientWidth, window.innerWidth || 0),
                s = R(t.clientHeight, window.innerHeight || 0),
                o = a(t),
                r = a(t, "left");
            return h({
        ...
        function v(e, t, s, o) {
            ...
            if ("viewport" === o) a = m(l);
                ...
                var u;
                "scrollParent" === o ? "BODY" === (u = n(i(e))).nodeName && (u = window.document.documentElement) : u = "window" === o ? window.document.documentElement : o;
                var c = f(u, l);
        ...
        function S(e, t, i) {
            ...
            var n = w(e),
                ...
                l = o ? "height" : "width",
                u = o ? "width" : "height";
            return s[r] = t[r] + t[l] / 2 - n[l] / 2, s[a] = i === a ? t[a] - n[u] : t[T(a)], s
        }
        ...
        function O(e, t) {
            Object.keys(t).forEach(function (i) {
                var n = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(i) && A(t[i]) && (n = "px"), e.style[i] = t[i] + n
            })
        }
            ...
            return (u = u.map(function (e, n) {
                ...
                return e.reduce(function (e, t) {
                    ...
                    return function (e, t, i, n) {
                        ...
                        return "vh" === r || "vw" === r ? ("vh" === r ? R(document.documentElement.clientHeight, window.innerHeight || 0) : R(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * o : o
                    }(e, s, t, i)
                })
        ...
        for (var L = Math.min, q = Math.floor, R = Math.max, $ = ["native code", "[object MutationObserverConstructor]"], M = "undefined" != typeof window, H = ["Edge", "Trident", "Firefox"], F = 0, B = 0; B < H.length; B += 1)
            if (M && 0 <= navigator.userAgent.indexOf(H[B])) {
                F = 1;
                break
            } var W, U = M && function (e) {
            ...
            te = function () {
                function t(i, n) {
                    ...
                    }, this.update = U(this.update.bind(this)), this.options = G({}, t.Defaults, o), this.state = {
                        isDestroyed: !1,
                        isCreated: !1,
                        scrollParents: []
                    }, this.reference = i.jquery ? i[0] : i, this.popper = n.jquery ? n[0] : n, this.options.modifiers = {}, Object.keys(G({}, t.Defaults.modifiers, o.modifiers)).forEach(function (e) {
                        s.options.modifiers[e] = G({}, t.Defaults.modifiers[e] || {}, o.modifiers ? o.modifiers[e] : {})
                    ...
                    value: function () {
                        return function () {
                            if (!this.state.isDestroyed) {
                                ...
                                e.offsets.reference = _(this.state, this.popper, this.reference), e.placement = b(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.offsets.popper = S(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = "absolute", e = C(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                            }
                        }.call(this)
                    }
                }, {
        ...
        return te.Utils = ("undefined" == typeof window ? global : window).PopperUtils, te.placements = X, te.Defaults = {
            placement: "bottom",
            eventsEnabled: !0,
            removeOnDestroy: !1,
            onCreate: function () {},
            ...
            modifiers: {
                ...
                offset: {
                    ...
                    fn: function (e, t) {
                        var i, n = t.offset,
                            ...
                            a = o.reference,
                            l = s.split("-")[0];
                        return i = A(+n) ? [+n, 0] : I(n, r, a, l), "left" === l ? (r.top += i[0], r.left -= i[1]) : "right" === l ? (r.top += i[0], r.left += i[1]) : "top" === l ? (r.left += i[0], r.top -= i[1]) : "bottom" === l && (r.left += i[0], r.top += i[1]), e.popper = r, e
                    },
                    offset: 0
                },
                preventOverflow: {
                    ...
                    fn: function (e, t) {
                        ...
                        var o = t.priority,
                            ...
                            a = {
                                primary: function (e) {
                                    var i = r[e];
                                    return r[e] < n[e] && !t.escapeWithReference && (i = R(r[e], n[e])), Y({}, e, i)
                                },
                                secondary: function (e) {
                                    var i = "right" === e ? "left" : "top",
                                        s = r[i];
                                    return r[e] > n[e] && !t.escapeWithReference && (s = L(r[i], n[e] - ("right" === e ? r.width : r.height))), Y({}, i, s)
                                }
                            };
                ...
                arrow: {
                    ...
                    fn: function (e, t) {
                        ...
                        var n = e.placement.split("-")[0],
                            ...
                            d = a ? "bottom" : "right",
                            p = w(i)[l];
                        r[d] - p < o[u] && (e.offsets.popper[u] -= o[u] - (r[d] - p)), r[u] + p > o[d] && (e.offsets.popper[u] += r[u] + p - o[d]);
                        var f = r[u] + r[l] / 2 - p / 2 - h(e.offsets.popper)[u];
                        return f = R(L(o[l] - p, f), 0), e.arrowElement = i, e.offsets.arrow = {}, e.offsets.arrow[u] = Math.round(f), e.offsets.arrow[c] = "", e
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    fn: function (e, t) {
                        ...
                        return r.forEach(function (a, l) {
                            ...
                            (h || v || b) && (e.flipped = !0, (h || v) && (n = r[l + 1]), b && (o = function (e) {
                                return "end" === e ? "start" : "start" === e ? "end" : e
                            }(o)), e.placement = n + (o ? "-" + o : ""), e.offsets.popper = G({}, e.offsets.popper, S(e.instance.popper, e.offsets.reference, e.placement)), e = C(e.instance.modifiers, e, "flip"))
                        }), e
                    },
                    behavior: "flip",
                    padding: 5,
                ...
                inner: {
                    ...
                    fn: function (e) {
                        ...
                        return s[r ? "left" : "top"] = o[t] - (a ? s[r ? "width" : "height"] : 0), e.placement = T(t), e.offsets.popper = h(s), e
                    }
                },
                hide: {
                    order: 800,
                ...
                computeStyle: {
                    ...
                    fn: function (e, t) {
                        ...
                        return e.attributes = G({}, b, e.attributes), e.styles = G({}, d, e.styles), e
                    },
                    gpuAcceleration: !0,
                    x: "bottom",
                    y: "right"
                ...
                applyStyle: {
                    ...
                    fn: function (e) {
                        return O(e.instance.popper, e.styles),
                            ...
                            }(e.instance.popper, e.attributes), e.offsets.arrow && O(e.arrowElement, e.offsets.arrow), e
                    },
                    onLoad: function (e, t, i, n, s) {
                        var o = _(0, t, e),
                            r = b(i.placement, o, t, e, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding);
...
function setActiveStyleSheet(e) {
    var t, i;
    for (t = 0; i = document.getElementsByTagName("link")[t]; t++) - 1 != i.getAttribute("rel").indexOf("style") && i.getAttribute("title") && (i.disabled = !0, i.getAttribute("title") == e && (i.disabled = !1))
}
        ...
        s = (function (t) {
            var s = "alert",
                ...
                h = function () {
                    ...
                    return s.prototype.close = function (e) {
                        e = e || this._element;
                        var t = this._getRootElement(e);
                        this._triggerCloseEvent(t).isDefaultPrevented() || this._removeElement(t)
                    }, s.prototype.dispose = function () {
                        t.removeData(this._element, "bs.alert"), this._element = null
                    }, s.prototype._getRootElement = function (e) {
                        var i = n.getSelectorFromElement(e),
                            s = !1;
                        return i && (s = t(i)[0]), s || (s = t(e).closest("." + u)[0]), s
                    }, s.prototype._triggerCloseEvent = function (e) {
                        var i = t.Event(r);
                        return t(e).trigger(i), i
                    }, s.prototype._removeElement = function (e) {
                        var i = this;
                        t(e).removeClass(d), n.supportsTransitionEnd() && t(e).hasClass(c) ? t(e).one(n.TRANSITION_END, function (t) {
                            return i._destroyElement(e, t)
                        }).emulateTransitionEnd(150) : this._destroyElement(e)
                    }, s.prototype._destroyElement = function (e) {
                        t(e).detach().trigger(a).remove()
                    }, s._jQueryInterface = function (e) {
                        return this.each(function () {
                            var i = t(this),
                                n = i.data("bs.alert");
                            n || (n = new s(this), i.data("bs.alert", n)), "close" === e && n[e](this)
                        })
            ...
            t(document).on(l, '[data-dismiss="alert"]', h._handleDismiss(new h)), t.fn[s] = h._jQueryInterface, t.fn[s].Constructor = h, t.fn[s].noConflict = function () {
                return t.fn[s] = o, h._jQueryInterface
            }
        }(jQuery), function (t) {
            var n = "button",
                s = t.fn[n],
                ...
                f = "focus.bs.button.data-api blur.bs.button.data-api",
                m = function () {
                    function n(t) {
                    ...
                    return n.prototype.toggle = function () {
                        var e = !0,
                            i = !0,
                            n = t(this._element).closest(u)[0];
                        if (n) {
                            var s = t(this._element).find(c)[0];
                            if (s) {
                                if ("radio" === s.type)
                                    if (s.checked && t(this._element).hasClass(o)) e = !1;
                                    else {
                                        var r = t(n).find(d)[0];
                                        r && t(r).removeClass(o)
                                    } if (e) {
                                    if (s.hasAttribute("disabled") || n.hasAttribute("disabled") || s.classList.contains("disabled") || n.classList.contains("disabled")) return;
                                    s.checked = !t(this._element).hasClass(o), t(s).trigger("change")
                                }
                                s.focus(), i = !1
                            }
                        }
                        i && this._element.setAttribute("aria-pressed", !t(this._element).hasClass(o)), e && t(this._element).toggleClass(o)
            ...
            t(document).on(p, l, function (e) {
                e.preventDefault();
                var i = e.target;
                t(i).hasClass(r) || (i = t(i).closest(h)), m._jQueryInterface.call(t(i), "toggle")
            }).on(f, l, function (e) {
                var i = t(e.target).closest(h)[0];
                t(i).toggleClass(a, /^focus(in)?$/.test(e.type))
            }), t.fn[n] = m._jQueryInterface, t.fn[n].Constructor = m, t.fn[n].noConflict = function () {
                return t.fn[n] = s, m._jQueryInterface
            }
        }(jQuery), function (s) {
            var o = "carousel",
                r = "bs.carousel",
                ...
                k = function () {
                    function l(t, i) {
                        e(this, l), this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(i), this._element = s(t)[0], this._indicatorsElement = s(this._element).find(S.INDICATORS)[0], this._addEventListeners()
                    }
                    return l.prototype.next = function () {
                        ...
                        e || (this._isPaused = !0), s(this._element).find(S.NEXT_PREV)[0] && n.supportsTransitionEnd() && (n.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
                    }, l.prototype.cycle = function (e) {
                        e || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval))
                    }, l.prototype.to = function (e) {
                        var t = this;
                        this._activeElement = s(this._element).find(S.ACTIVE_ITEM)[0];
                        var i = this._getItemIndex(this._activeElement);
                        if (!(e > this._items.length - 1 || e < 0))
                            if (this._isSliding) s(this._element).one(m.SLID, function () {
                                return t.to(e)
                            });
                            else {
                        ...
                        s(this._element).off(a), s.removeData(this._element, r), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                    }, l.prototype._getConfig = function (e) {
                        return e = s.extend({}, u, e), n.typeCheckConfig(o, e, c), e
                    }, l.prototype._addEventListeners = function () {
                        var e = this;
                        this._config.keyboard && s(this._element).on(m.KEYDOWN, function (t) {
                            return e._keydown(t)
                        }), "hover" === this._config.pause && (s(this._element).on(m.MOUSEENTER, function (t) {
                            return e.pause(t)
                        }).on(m.MOUSELEAVE, function (t) {
                            return e.cycle(t)
                        }), "ontouchstart" in document.documentElement && s(this._element).on(m.TOUCHEND, function () {
                        ...
                        return this._items = s.makeArray(s(e).parent().find(S.ITEM)), this._items.indexOf(e)
                        ...
                        var r = (s + (e === h ? -1 : 1)) % this._items.length;
                        return -1 === r ? this._items[this._items.length - 1] : this._items[r]
                    }, l.prototype._triggerSlideEvent = function (e, t) {
                        var i = this._getItemIndex(e),
                            n = this._getItemIndex(s(this._element).find(S.ACTIVE_ITEM)[0]),
                            o = s.Event(m.SLIDE, {
                                relatedTarget: e,
                                direction: t,
                                from: n,
                        ...
                        if (this._indicatorsElement) {
                            s(this._indicatorsElement).find(S.ACTIVE).removeClass(v);
                            var t = this._indicatorsElement.children[this._getItemIndex(e)];
                            t && s(t).addClass(v)
                        }
                    }, l.prototype._slide = function (e, t) {
                        var i = this,
                            o = s(this._element).find(S.ACTIVE_ITEM)[0],
                            ...
                            h = void 0,
                            g = void 0;
                        if (e === d ? (c = _, h = w, g = p) : (c = b, h = T, g = f), a && s(a).hasClass(v)) this._isSliding = !1;
                            ...
                            var k = s.Event(m.SLID, {
                                relatedTarget: a,
                                direction: g,
                                from: r,
                                to: l
                            });
                            n.supportsTransitionEnd() && s(this._element).hasClass(y) ? (s(a).addClass(h), n.reflow(a), s(o).addClass(c), s(a).addClass(c), s(o).one(n.TRANSITION_END, function () {
                                s(a).removeClass(c + " " + h).addClass(v), s(o).removeClass(v + " " + h + " " + c), i._isSliding = !1, setTimeout(function () {
                                    return s(i._element).trigger(k)
                                }, 0)
                            }).emulateTransitionEnd(600)) : (s(o).removeClass(v), s(a).addClass(v), this._isSliding = !1, s(this._element).trigger(k)), u && this.cycle()
                        }
                    }, l._jQueryInterface = function (e) {
                        return this.each(function () {
                            var i = s(this).data(r),
                                n = s.extend({}, u, s(this).data());
                            "object" === (void 0 === e ? "undefined" : t(e)) && s.extend(n, e);
                            var o = "string" == typeof e ? e : n.slide;
                            if (i || (i = new l(this, n), s(this).data(r, i)), "number" == typeof e) i.to(e);
                        ...
                        var t = n.getSelectorFromElement(this);
                        if (t) {
                            var i = s(t)[0];
                            if (i && s(i).hasClass(g)) {
                                var o = s.extend({}, s(i).data(), s(this).data()),
                                    a = this.getAttribute("data-slide-to");
                                a && (o.interval = !1), l._jQueryInterface.call(s(i), o), a && s(i).data(r).to(a), e.preventDefault()
                            }
                        }
                    }, i(l, null, [{
                        key: "VERSION",
            ...
            s(document).on(m.CLICK_DATA_API, S.DATA_SLIDE, k._dataApiClickHandler), s(window).on(m.LOAD_DATA_API, function () {
                s(S.DATA_RIDE).each(function () {
                    var e = s(this);
                    k._jQueryInterface.call(e, e.data())
                })
            }), s.fn[o] = k._jQueryInterface, s.fn[o].Constructor = k, s.fn[o].noConflict = function () {
                return s.fn[o] = l, k._jQueryInterface
            }
        }(jQuery), function (s) {
            var o = "collapse",
                r = "bs.collapse",
                ...
                T = function () {
                    function a(t, i) {
                        e(this, a), this._isTransitioning = !1, this._element = t, this._config = this._getConfig(i), this._triggerArray = s.makeArray(s('[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]'));
                        for (var o = s(w.DATA_TOGGLE), r = 0; r < o.length; r++) {
                            var l = o[r],
                                u = n.getSelectorFromElement(l);
                            null !== u && s(u).filter(t).length > 0 && this._triggerArray.push(l)
                        }
                        this._parent = this._config.parent ? this._getParent() : null, this._config.parent || this._addAriaAndCollapsedClass(this._element, this._triggerArray), this._config.toggle && this.toggle()
                    }
                    return a.prototype.toggle = function () {
                        s(this._element).hasClass(m) ? this.hide() : this.show()
                    }, a.prototype.show = function () {
                        var e = this;
                        if (!this._isTransitioning && !s(this._element).hasClass(m)) {
                            var t = void 0,
                                i = void 0;
                            if (this._parent && ((t = s.makeArray(s(this._parent).children().children(w.ACTIVES))).length || (t = null)), !(t && (i = s(t).data(r)) && i._isTransitioning)) {
                                var o = s.Event(c);
                                if (s(this._element).trigger(o), !o.isDefaultPrevented()) {
                                    t && (a._jQueryInterface.call(s(t), "hide"), i || s(t).data(r, null));
                                    var l = this._getDimension();
                                    s(this._element).removeClass(g).addClass(v), this._element.style[l] = 0, this._triggerArray.length && s(this._triggerArray).removeClass(y).attr("aria-expanded", !0), this.setTransitioning(!0);
                                    var u = function () {
                                        s(e._element).removeClass(v).addClass(g).addClass(m), e._element.style[l] = "", e.setTransitioning(!1), s(e._element).trigger(d)
                                    };
                                    if (n.supportsTransitionEnd()) {
                                        var h = "scroll" + (l[0].toUpperCase() + l.slice(1));
                                        s(this._element).one(n.TRANSITION_END, u).emulateTransitionEnd(600), this._element.style[l] = this._element[h] + "px"
                                    } else u()
                                }
                            }
                        }
                        ...
                        if (!this._isTransitioning && s(this._element).hasClass(m)) {
                            ...
                            if (s(this._element).trigger(t), !t.isDefaultPrevented()) {
                                ...
                                if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", n.reflow(this._element), s(this._element).addClass(v).removeClass(g).removeClass(m), this._triggerArray.length)
                                    for (var o = 0; o < this._triggerArray.length; o++) {
                                        var r = this._triggerArray[o],
                                            a = n.getSelectorFromElement(r);
                                        null !== a && (s(a).hasClass(m) || s(r).addClass(y).attr("aria-expanded", !1))
                                    }
                                this.setTransitioning(!0);
                                var l = function () {
                                    e.setTransitioning(!1), s(e._element).removeClass(v).addClass(g).trigger(p)
                                };
                                this._element.style[i] = "", n.supportsTransitionEnd() ? s(this._element).one(n.TRANSITION_END, l).emulateTransitionEnd(600) : l()
                            }
                        }
                    }, a.prototype.setTransitioning = function (e) {
                        this._isTransitioning = e
                    }, a.prototype.dispose = function () {
                        s.removeData(this._element, r), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
                    }, a.prototype._getConfig = function (e) {
                        return (e = s.extend({}, l, e)).toggle = Boolean(e.toggle), n.typeCheckConfig(o, e, u), e
                    }, a.prototype._getDimension = function () {
                        return s(this._element).hasClass(b) ? b : _
                    }, a.prototype._getParent = function () {
                        var e = this,
                            t = s(this._config.parent)[0],
                            i = '[data-toggle="collapse"][data-parent="' + this._config.parent + '"]';
                        return s(t).find(i).each(function (t, i) {
                            e._addAriaAndCollapsedClass(a._getTargetFromElement(i), [i])
                        }), t
                    }, a.prototype._addAriaAndCollapsedClass = function (e, t) {
                        if (e) {
                            var i = s(e).hasClass(m);
                            t.length && s(t).toggleClass(y, !i).attr("aria-expanded", i)
                        }
                        ...
                        return this.each(function () {
                            var i = s(this),
                                n = i.data(r),
                                o = s.extend({}, l, i.data(), "object" === (void 0 === e ? "undefined" : t(e)) && e);
            ...
            s(document).on(f, w.DATA_TOGGLE, function (e) {
            ...
            }), s.fn[o] = T._jQueryInterface, s.fn[o].Constructor = T, s.fn[o].noConflict = function () {
                return s.fn[o] = a, T._jQueryInterface
            }
        }(jQuery), function (s) {
            ...
            var o = "dropdown",
                ...
                k = function () {
                    function l(t, i) {
                        e(this, l), this._element = t, this._popper = null, this._config = this._getConfig(i), this._menu = this._getMenuElement(), this._inNavbar = this._detectNavbar(), this._addEventListeners()
                    }
                    return l.prototype.toggle = function () {
                        if (!this._element.disabled && !s(this._element).hasClass(d)) {
                            var e = l._getParentFromElement(this._element),
                                t = s(this._menu).hasClass(h);
                            if (l._clearMenus(), !t) {
                                var i = {
                                        relatedTarget: this._element
                                    },
                                    n = s.Event(c.SHOW, i);
                                if (s(e).trigger(n), !n.isDefaultPrevented()) {
                                    var o = this._element;
                                    s(e).hasClass(p) && (s(this._menu).hasClass(m) || s(this._menu).hasClass(f)) && (o = e), this._popper = new Popper(o, this._menu, this._getPopperConfig()), "ontouchstart" in document.documentElement && !s(e).closest(b).length && s("body").children().on("mouseover", null, s.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), s(this._menu).toggleClass(h), s(e).toggleClass(h).trigger(s.Event(c.SHOWN, i))
                                }
                            }
                        }
                    }, l.prototype.dispose = function () {
                        s.removeData(this._element, r), s(this._element).off(a), this._element = null, this._menu = null, null !== this._popper && this._popper.destroy(), this._popper = null
                    }, l.prototype.update = function () {
                        this._inNavbar = this._detectNavbar(), null !== this._popper && this._popper.scheduleUpdate()
                    }, l.prototype._addEventListeners = function () {
                        var e = this;
                        s(this._element).on(c.CLICK, function (t) {
                            t.preventDefault(), t.stopPropagation(), e.toggle()
                        })
                    }, l.prototype._getConfig = function (e) {
                        var t = s(this._element).data();
                        return void 0 !== t.placement && (t.placement = w[t.placement.toUpperCase()]), e = s.extend({}, this.constructor.Default, s(this._element).data(), e), n.typeCheckConfig(o, e, this.constructor.DefaultType), e
                    }, l.prototype._getMenuElement = function () {
                        if (!this._menu) {
                            var e = l._getParentFromElement(this._element);
                            this._menu = s(e).find(y)[0]
                        }
                        return this._menu
                    }, l.prototype._getPlacement = function () {
                        var e = s(this._element).parent(),
                            t = this._config.placement;
                        return e.hasClass(p) || this._config.placement === w.TOP ? (t = w.TOP, s(this._menu).hasClass(f) && (t = w.TOPEND)) : s(this._menu).hasClass(f) && (t = w.BOTTOMEND), t
                        ...
                        return this.each(function () {
                            var i = s(this).data(r),
                                n = "object" === (void 0 === e ? "undefined" : t(e)) ? e : null;
                            if (i || (i = new l(this, n), s(this).data(r, i)), "string" == typeof e) {
                        ...
                        if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                            for (var t = s.makeArray(s(g)), i = 0; i < t.length; i++) {
                                ...
                                if (o) {
                                    var u = o._menu;
                                    if (s(n).hasClass(h) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && s.contains(n, e.target))) {
                                        var d = s.Event(c.HIDE, a);
                                        s(n).trigger(d), d.isDefaultPrevented() || ("ontouchstart" in document.documentElement && s("body").children().off("mouseover", null, s.noop), t[i].setAttribute("aria-expanded", "false"), s(u).removeClass(h), s(n).removeClass(h).trigger(s.Event(c.HIDDEN, a)))
                                    }
                                }
                            }
                        ...
                        return i && (t = s(i)[0]), t || e.parentNode
                    }, l._dataApiKeydownHandler = function (e) {
                        if (!(!u.test(e.which) || /button/i.test(e.target.tagName) && 32 === e.which || /input|textarea/i.test(e.target.tagName) || (e.preventDefault(), e.stopPropagation(), this.disabled || s(this).hasClass(d)))) {
                            var t = l._getParentFromElement(this),
                                i = s(t).hasClass(h);
                            if ((i || 27 === e.which && 32 === e.which) && (!i || 27 !== e.which && 32 !== e.which)) {
                                var n = s(t).find(_).get();
                                if (n.length) {
            ...
            s(document).on(c.KEYDOWN_DATA_API, g, k._dataApiKeydownHandler).on(c.KEYDOWN_DATA_API, y, k._dataApiKeydownHandler).on(c.CLICK_DATA_API + " " + c.KEYUP_DATA_API, k._clearMenus).on(c.CLICK_DATA_API, g, function (e) {
            ...
            var o = "modal",
                ...
                E = function () {
                    function r(t, i) {
                        e(this, r), this._config = this._getConfig(i), this._element = t, this._dialog = s(t).find(C.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0
                    }
                    return r.prototype.toggle = function (e) {
                        ...
                        if (!this._isTransitioning) {
                            n.supportsTransitionEnd() && s(this._element).hasClass(S) && (this._isTransitioning = !0);
                            var i = s.Event(d, {
                                relatedTarget: e
                            });
                            s(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), s(document.body).addClass(T), this._setEscapeEvent(), this._setResizeEvent(), s(this._element).on(m, C.DATA_DISMISS, function (e) {
                                return t.hide(e)
                            }), s(this._dialog).on(y, function () {
                                s(t._element).one(v, function (e) {
                        ...
                        if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                            var i = n.supportsTransitionEnd() && s(this._element).hasClass(S);
                            i && (this._isTransitioning = !0);
                            var o = s.Event(u);
                            s(this._element).trigger(o), this._isShown && !o.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), s(document).off(p), s(this._element).removeClass(k), s(this._element).off(m), s(this._dialog).off(y), i ? s(this._element).one(n.TRANSITION_END, function (e) {
                        ...
                        return e = s.extend({}, a, e), n.typeCheckConfig(o, e, l), e
                    }, r.prototype._showElement = function (e) {
                        var t = this,
                            i = n.supportsTransitionEnd() && s(this._element).hasClass(S);
                        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, i && n.reflow(this._element), s(this._element).addClass(k), this._config.focus && this._enforceFocus();
                        var o = s.Event(h, {
                                relatedTarget: e
                            }),
                            r = function () {
                                t._config.focus && t._element.focus(), t._isTransitioning = !1, s(t._element).trigger(o)
                            };
                        i ? s(this._dialog).one(n.TRANSITION_END, r).emulateTransitionEnd(300) : r()
                    }, r.prototype._enforceFocus = function () {
                        var e = this;
                        s(document).off(p).on(p, function (t) {
                            document === t.target || e._element === t.target || s(e._element).has(t.target).length || e._element.focus()
                        })
                    }, r.prototype._setEscapeEvent = function () {
                        var e = this;
                        this._isShown && this._config.keyboard ? s(this._element).on(g, function (t) {
                            27 === t.which && (t.preventDefault(), e.hide())
                        }) : this._isShown || s(this._element).off(g)
                    }, r.prototype._setResizeEvent = function () {
                        var e = this;
                        this._isShown ? s(window).on(f, function (t) {
                            return e.handleUpdate(t)
                        }) : s(window).off(f)
                    }, r.prototype._hideModal = function () {
                        var e = this;
                        this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._isTransitioning = !1, this._showBackdrop(function () {
                            s(document.body).removeClass(T), e._resetAdjustments(), e._resetScrollbar(), s(e._element).trigger(c)
                        })
                        ...
                        var t = this,
                            i = s(this._element).hasClass(S) ? S : "";
                        if (this._isShown && this._config.backdrop) {
                            var o = n.supportsTransitionEnd() && i;
                            if (this._backdrop = document.createElement("div"), this._backdrop.className = w, i && s(this._backdrop).addClass(i), s(this._backdrop).appendTo(document.body), s(this._element).on(m, function (e) {
                                    t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._element.focus() : t.hide())
                                }), o && n.reflow(this._backdrop), s(this._backdrop).addClass(k), !e) return;
                            if (!o) return void e();
                            s(this._backdrop).one(n.TRANSITION_END, e).emulateTransitionEnd(150)
                        } else if (!this._isShown && this._backdrop) {
                            s(this._backdrop).removeClass(k);
                            var r = function () {
                                t._removeBackdrop(), e && e()
                            };
                            n.supportsTransitionEnd() && s(this._element).hasClass(S) ? s(this._backdrop).one(n.TRANSITION_END, r).emulateTransitionEnd(150) : r()
                        } else e && e()
                        ...
                        if (this._isBodyOverflowing) {
                            s(C.FIXED_CONTENT).each(function (t, i) {
                                var n = s(i)[0].style.paddingRight,
                                    o = s(i).css("padding-right");
                                s(i).data("padding-right", n).css("padding-right", parseFloat(o) + e._scrollbarWidth + "px")
                            }), s(C.NAVBAR_TOGGLER).each(function (t, i) {
                                var n = s(i)[0].style.marginRight,
                                    o = s(i).css("margin-right");
                                s(i).data("margin-right", n).css("margin-right", parseFloat(o) + e._scrollbarWidth + "px")
                            });
                            var t = document.body.style.paddingRight,
                                i = s("body").css("padding-right");
                            s("body").data("padding-right", t).css("padding-right", parseFloat(i) + this._scrollbarWidth + "px")
                        }
                        ...
                        }), s(C.NAVBAR_TOGGLER).each(function (e, t) {
                        ...
                        return this.each(function () {
                            var n = s(this).data("bs.modal"),
                                o = s.extend({}, r.Default, s(this).data(), "object" === (void 0 === e ? "undefined" : t(e)) && e);
                            if (n || (n = new r(this, o), s(this).data("bs.modal", n)), "string" == typeof e) {
                                if (void 0 === n[e]) throw new Error('No method named "' + e + '"');
                                n[e](i)
            ...
            s(document).on(b, C.DATA_TOGGLE, function (e) {
                var t = this,
                    i = void 0,
                ...
                var a = s(i).one(d, function (e) {
                    e.isDefaultPrevented() || a.one(c, function () {
                        s(t).is(":visible") && t.focus()
                    })
                });
                E._jQueryInterface.call(s(i), r, this)
            }), s.fn[o] = E._jQueryInterface, s.fn[o].Constructor = E, s.fn[o].noConflict = function () {
                return s.fn[o] = r, E._jQueryInterface
            }
        }(jQuery), function (s) {
            var o = "scrollspy",
                r = s.fn[o],
                ...
                m = function () {
                    function r(t, i) {
                        var n = this;
                        e(this, r), this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(i), this._selector = this._config.target + " " + h.NAV_LINKS + "," + this._config.target + " " + h.LIST_ITEMS + "," + this._config.target + " " + h.DROPDOWN_ITEMS, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, s(this._scrollElement).on(u.SCROLL, function (e) {
                            return n._process(e)
                        }), this.refresh(), this._process()
                    }
                    return r.prototype.refresh = function () {
                        var e = this,
                            t = this._scrollElement !== this._scrollElement.window ? f : p,
                        ...
                        this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), s.makeArray(s(this._selector)).map(function (e) {
                            ...
                            if (r && (t = s(r)[0]), t) {
                                ...
                                if (a.width || a.height) return [s(t)[i]().top + o, r]
                            }
                            return null
                        }).filter(function (e) {
                            return e
                        ...
                        if ("string" != typeof (e = s.extend({}, a, e)).target) {
                            var t = s(e.target).attr("id");
                            t || (t = n.getUID(o), s(e.target).attr("id", t)), e.target = "#" + t
                        }
                        return n.typeCheckConfig(o, e, l), e
                        ...
                        var i = s(t.join(","));
                        i.hasClass(c) ? (i.closest(h.DROPDOWN).find(h.DROPDOWN_TOGGLE).addClass(d), i.addClass(d)) : (i.addClass(d), i.parents(h.NAV_LIST_GROUP).prev(h.NAV_LINKS + ", " + h.LIST_ITEMS).addClass(d)), s(this._scrollElement).trigger(u.ACTIVATE, {
                            relatedTarget: e
                        })
                    }, r.prototype._clear = function () {
                        s(this._selector).filter(h.ACTIVE).removeClass(d)
                    }, r._jQueryInterface = function (e) {
                        return this.each(function () {
                            var i = s(this).data("bs.scrollspy"),
                                n = "object" === (void 0 === e ? "undefined" : t(e)) && e;
                            if (i || (i = new r(this, n), s(this).data("bs.scrollspy", i)), "string" == typeof e) {
                                if (void 0 === i[e]) throw new Error('No method named "' + e + '"');
                                i[e]()
                            }
                        })
            ...
            s(window).on(u.LOAD_DATA_API, function () {
                for (var e = s.makeArray(s(h.DATA_SPY)), t = e.length; t--;) {
                    var i = s(e[t]);
                    m._jQueryInterface.call(i, i.data())
                }
            }), s.fn[o] = m._jQueryInterface, s.fn[o].Constructor = m, s.fn[o].noConflict = function () {
                return s.fn[o] = r, m._jQueryInterface
            }
        }(jQuery), function (t) {
            var s = t.fn.tab,
                o = "hide.bs.tab",
                ...
                w = function () {
                    ...
                    return s.prototype.show = function () {
                        var e = this;
                        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(d) || t(this._element).hasClass(h))) {
                            var i = void 0,
                                s = void 0,
                                u = t(this._element).closest(g)[0],
                                c = n.getSelectorFromElement(this._element);
                            u && (s = (s = t.makeArray(t(u).find(v)))[s.length - 1]);
                            var p = t.Event(o, {
                                    relatedTarget: this._element
                                }),
                                f = t.Event(a, {
                            ...
                            if (s && t(s).trigger(p), t(this._element).trigger(f), !f.isDefaultPrevented() && !p.isDefaultPrevented()) {
                                c && (i = t(c)[0]), this._activate(this._element, u);
                                var m = function () {
                                    var i = t.Event(r, {
                                    ...
                                    t(s).trigger(i), t(e._element).trigger(n)
                                };
                    ...
                    }, s.prototype._activate = function (e, i, s) {
                        var o = this,
                            r = t(i).find(v)[0],
                            a = s && n.supportsTransitionEnd() && r && t(r).hasClass(p),
                            l = function () {
                                return o._transitionComplete(e, r, a, s)
                            };
                        r && a ? t(r).one(n.TRANSITION_END, l).emulateTransitionEnd(150) : l(), r && t(r).removeClass(f)
                    }, s.prototype._transitionComplete = function (e, i, s, o) {
                        if (i) {
                            t(i).removeClass(d);
                            var r = t(i.parentNode).find(_)[0];
                            r && t(r).removeClass(d), i.setAttribute("aria-expanded", !1)
                        }
                        if (t(e).addClass(d), e.setAttribute("aria-expanded", !0), s ? (n.reflow(e), t(e).addClass(f)) : t(e).removeClass(p), e.parentNode && t(e.parentNode).hasClass(c)) {
                            var a = t(e).closest(m)[0];
                            a && t(a).find(b).addClass(d), e.setAttribute("aria-expanded", !0)
                        }
                        o && o()
                    }, s._jQueryInterface = function (e) {
                        return this.each(function () {
                            var i = t(this),
                                n = i.data("bs.tab");
                            if (n || (n = new s(this), i.data("bs.tab", n)), "string" == typeof e) {
                                if (void 0 === n[e]) throw new Error('No method named "' + e + '"');
                                n[e]()
                            }
                        })
            ...
            t(document).on(u, y, function (e) {
                e.preventDefault(), w._jQueryInterface.call(t(this), "show")
            }), t.fn.tab = w._jQueryInterface, t.fn.tab.Constructor = w, t.fn.tab.noConflict = function () {
                return t.fn.tab = s, w._jQueryInterface
            }
        }(jQuery), function (s) {
            ...
            var o = "tooltip",
                ...
                S = function () {
                    function a(t, i) {
                        e(this, a), this._isEnabled = !0, this._timeout = 0, this._hoverState = "", this._activeTrigger = {}, this._popper = null, this.element = t, this.config = this._getConfig(i), this.tip = null, this._setListeners()
                    }
                    return a.prototype.enable = function () {
                        ...
                        if (e) {
                            var t = this.constructor.DATA_KEY,
                                i = s(e.currentTarget).data(t);
                            i || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()), s(e.currentTarget).data(t, i)), i._activeTrigger.click = !i._activeTrigger.click, i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(null, i)
                        } else {
                            if (s(this.getTipElement()).hasClass(g)) return void this._leave(null, this);
                            this._enter(null, this)
                        }
                    }, a.prototype.dispose = function () {
                        clearTimeout(this._timeout), s.removeData(this.element, this.constructor.DATA_KEY), s(this.element).off(this.constructor.EVENT_KEY), s(this.element).closest(".modal").off("hide.bs.modal"), this.tip && s(this.tip).remove(), this._isEnabled = null, this._timeout = null, this._hoverState = null, this._activeTrigger = null, null !== this._popper && this._popper.destroy(), this._popper = null, this.element = null, this.config = null, this.tip = null
                    }, a.prototype.show = function () {
                        var e = this;
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && s(o).addClass(m);
                            var l = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
                                u = this._getAttachment(l);
                            this.addAttachmentClass(u);
                            var c = !1 === this.config.container ? document.body : s(this.config.container);
                            s(o).data(this.constructor.DATA_KEY, this), s.contains(this.element.ownerDocument.documentElement, this.tip) || s(o).appendTo(c), s(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new Popper(this.element, o, {
                                placement: u,
                                modifiers: {
                                    offset: {
                            ...
                            }), s(o).addClass(g), "ontouchstart" in document.documentElement && s("body").children().on("mouseover", null, s.noop);
                            var d = function () {
                                e.config.animation && e._fixTransition();
                                var t = e._hoverState;
                                e._hoverState = null, s(e.element).trigger(e.constructor.Event.SHOWN), t === p && e._leave(null, e)
                            };
                            n.supportsTransitionEnd() && s(this.tip).hasClass(m) ? s(this.tip).one(n.TRANSITION_END, d).emulateTransitionEnd(a._TRANSITION_DURATION) : d()
                        }
                        ...
                        var t = this,
                            ...
                            r = function () {
                                t._hoverState !== h && i.parentNode && i.parentNode.removeChild(i), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), s(t.element).trigger(t.constructor.Event.HIDDEN), null !== t._popper && t._popper.destroy(), e && e()
                            };
                        s(this.element).trigger(o), o.isDefaultPrevented() || (s(i).removeClass(g), "ontouchstart" in document.documentElement && s("body").children().off("mouseover", null, s.noop), this._activeTrigger[w] = !1, this._activeTrigger[_] = !1, this._activeTrigger[b] = !1, n.supportsTransitionEnd() && s(this.tip).hasClass(m) ? s(i).one(n.TRANSITION_END, r).emulateTransitionEnd(150) : r(), this._hoverState = "")
                        ...
                        this.setElementContent(e.find(v), this.getTitle()), e.removeClass(m + " " + g)
                    }, a.prototype.setElementContent = function (e, i) {
                        var n = this.config.html;
                        "object" === (void 0 === i ? "undefined" : t(i)) && (i.nodeType || i.jquery) ? n ? s(i).parent().is(e) || e.empty().append(i) : e.text(s(i).text()): e[n ? "html" : "text"](i)
                        ...
                        this.config.trigger.split(" ").forEach(function (t) {
                            if ("click" === t) s(e.element).on(e.constructor.Event.CLICK, e.config.selector, function (t) {
                                return e.toggle(t)
                            });
                            else if (t !== T) {
                                var i = t === b ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
                                    n = t === b ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
                                s(e.element).on(i, e.config.selector, function (t) {
                                    return e._enter(t)
                                }).on(n, e.config.selector, function (t) {
                                    return e._leave(t)
                                })
                            }
                            s(e.element).closest(".modal").on("hide.bs.modal", function () {
                                return e.hide()
                            })
                        ...
                        (t = t || s(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), s(e.currentTarget).data(i, t)), e && (t._activeTrigger["focusin" === e.type ? _ : b] = !0), s(t.getTipElement()).hasClass(g) || t._hoverState === h ? t._hoverState = h : (clearTimeout(t._timeout), t._hoverState = h, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function () {
                            t._hoverState === h && t.show()
                        }, t.config.delay.show) : t.show())
                    }, a.prototype._leave = function (e, t) {
                        var i = this.constructor.DATA_KEY;
                        (t = t || s(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), s(e.currentTarget).data(i, t)), e && (t._activeTrigger["focusout" === e.type ? _ : b] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = p, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function () {
                        ...
                        return (e = s.extend({}, this.constructor.Default, s(this.element).data(), e)).delay && "number" == typeof e.delay && (e.delay = {
                            show: e.delay,
                            hide: e.delay
                        }), e.title && "number" == typeof e.title && (e.title = e.title.toString()), e.content && "number" == typeof e.content && (e.content = e.content.toString()), n.typeCheckConfig(o, e, this.constructor.DefaultType), e
                        ...
                        null === e.getAttribute("x-placement") && (s(e).removeClass(m), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
                    }, a._jQueryInterface = function (e) {
                        return this.each(function () {
                            var i = s(this).data("bs.tooltip"),
                                n = "object" === (void 0 === e ? "undefined" : t(e)) && e;
                            if ((i || !/dispose|hide/.test(e)) && (i || (i = new a(this, n), s(this).data("bs.tooltip", i)), "string" == typeof e)) {
                                if (void 0 === i[e]) throw new Error('No method named "' + e + '"');
                                i[e]()
                            }
                        })
            ...
            return s.fn[o] = S._jQueryInterface, s.fn[o].Constructor = S, s.fn[o].noConflict = function () {
                return s.fn[o] = a, S._jQueryInterface
            }, S
        }(jQuery));
    ! function (n) {
        var o = "popover",
            ...
            g = function (s) {
                ...
                return function (e, t) {
                ...
                }(a, s), a.prototype.isWithContent = function () {
                    ...
                    this.setElementContent(e.find(p), this.getTitle()), this.setElementContent(e.find(f), this._getContent()), e.removeClass(d + " " + h)
                    ...
                    return this.each(function () {
                        var i = n(this).data("bs.popover"),
                            s = "object" === (void 0 === e ? "undefined" : t(e)) ? e : null;
                        if ((i || !/destroy|hide/.test(e)) && (i || (i = new a(this, s), n(this).data("bs.popover", i)), "string" == typeof e)) {
                            if (void 0 === i[e]) throw new Error('No method named "' + e + '"');
                            i[e]()
                        }
                    })
        ...
        n.fn[o] = g._jQueryInterface, n.fn[o].Constructor = g, n.fn[o].noConflict = function () {
            return n.fn[o] = a, g._jQueryInterface
        }
    }(jQuery)
}(),
function (e) {
    ...
    (t = function () {
        ...
        return function (i, n) {
            ...
            if (a.defaults = {
                ...
                for (r in a.respondTo = a.options.respondTo || "window", o) o.hasOwnProperty(r) && (a.breakpoints.push(o[r].breakpoint), a.breakpointSettings[o[r].breakpoint] = o[r].settings);
                a.breakpoints.sort(function (e, t) {
                    return !0 === a.options.mobileFirst ? e - t : t - e
                })
            }
            void 0 !== document.mozHidden ? (a.hidden = "mozHidden", a.visibilityChange = "mozvisibilitychange") : void 0 !== document.webkitHidden && (a.hidden = "webkitHidden", a.visibilityChange = "webkitvisibilitychange"), a.autoPlay = e.proxy(a.autoPlay, a), a.autoPlayClear = e.proxy(a.autoPlayClear, a), a.changeSlide = e.proxy(a.changeSlide, a), a.clickHandler = e.proxy(a.clickHandler, a), a.selectHandler = e.proxy(a.selectHandler, a), a.setPosition = e.proxy(a.setPosition, a), a.swipeHandler = e.proxy(a.swipeHandler, a), a.dragHandler = e.proxy(a.dragHandler, a), a.keyHandler = e.proxy(a.keyHandler, a), a.autoPlayIterator = e.proxy(a.autoPlayIterator, a), a.instanceUid = t++, a.htmlExpr = /^(?:\s*(<[\w\W]+>)[^>]*)$/, a.init(!0), a.checkResponsive(!0)
        }
        ...
        })) : (s.applyTransition(), t = Math.ceil(t), n[s.animType] = !1 === s.options.vertical ? "translate3d(" + t + "px, 0px, 0px)" : "translate3d(0px," + t + "px, 0px)", s.$slideTrack.css(n), i && setTimeout(function () {
        ...
        if ("window" === o.respondTo ? s = l : "slider" === o.respondTo ? s = a : "min" === o.respondTo && (s = Math.min(l, a)), o.originalSettings.responsive && o.originalSettings.responsive.length > -1 && null !== o.originalSettings.responsive) {
        ...
        var n, s, o = this,
            r = e(t.target);
        switch (r.is("a") && t.preventDefault(), r.is("li") || (r = r.closest("li")), n = 0 != o.slideCount % o.options.slidesToScroll ? 0 : (o.slideCount - o.currentSlide) % o.options.slidesToScroll, t.data.message) {
            case "previous":
        ...
        var t, i, n, s = this,
            o = 0;
        return s.slideOffset = 0, i = s.$slides.first().outerHeight(), !0 === s.options.infinite ? (s.slideCount > s.options.slidesToShow && (s.slideOffset = -1 * s.slideWidth * s.options.slidesToShow, o = -1 * i * s.options.slidesToShow), 0 != s.slideCount % s.options.slidesToScroll && e + s.options.slidesToScroll > s.slideCount && s.slideCount > s.options.slidesToShow && (e > s.slideCount ? (s.slideOffset = -1 * (s.options.slidesToShow - (e - s.slideCount)) * s.slideWidth, o = -1 * (s.options.slidesToShow - (e - s.slideCount)) * i) : (s.slideOffset = -1 * s.slideCount % s.options.slidesToScroll * s.slideWidth, o = -1 * s.slideCount % s.options.slidesToScroll * i))) : e + s.options.slidesToShow > s.slideCount && (s.slideOffset = (e + s.options.slidesToShow - s.slideCount) * s.slideWidth, o = (e + s.options.slidesToShow - s.slideCount) * i), s.slideCount <= s.options.slidesToShow && (s.slideOffset = 0, o = 0), !0 === s.options.centerMode && !0 === s.options.infinite ? s.slideOffset += s.slideWidth * Math.floor(s.options.slidesToShow / 2) - s.slideWidth : !0 === s.options.centerMode && (s.slideOffset = 0, s.slideOffset += s.slideWidth * Math.floor(s.options.slidesToShow / 2)), t = !1 === s.options.vertical ? -1 * e * s.slideWidth + s.slideOffset : -1 * e * i + o, !0 === s.options.variableWidth && (t = (n = s.slideCount <= s.options.slidesToShow || !1 === s.options.infinite ? s.$slideTrack.children(".slick-slide").eq(e) : s.$slideTrack.children(".slick-slide").eq(e + s.options.slidesToShow))[0] ? -1 * n[0].offsetLeft : 0, !0 === s.options.centerMode && (t = (n = !1 === s.options.infinite ? s.$slideTrack.children(".slick-slide").eq(e) : s.$slideTrack.children(".slick-slide").eq(e + s.options.slidesToShow + 1))[0] ? -1 * n[0].offsetLeft : 0, t += (s.$list.width() - n.outerWidth()) / 2)), t
        ...
        var i, n, s = this;
        !0 === s.options.centerMode ? !0 === s.options.infinite ? n = (i = s.currentSlide + (s.options.slidesToShow / 2 + 1)) + s.options.slidesToShow + 2 : (i = Math.max(0, s.currentSlide - (s.options.slidesToShow / 2 + 1)), n = s.options.slidesToShow / 2 + 1 + 2 + s.currentSlide) : (n = (i = s.options.infinite ? s.options.slidesToShow + s.currentSlide : s.currentSlide) + s.options.slidesToShow, !0 === s.options.fade && (i > 0 && i--, n <= s.slideCount && n++)), t(s.$slider.find(".slick-slide").slice(i, n)), s.slideCount <= s.options.slidesToShow ? t(s.$slider.find(".slick-slide")) : s.currentSlide >= s.slideCount - s.options.slidesToShow ? t(s.$slider.find(".slick-cloned").slice(0, s.options.slidesToShow)) : 0 === s.currentSlide && t(s.$slider.find(".slick-cloned").slice(-1 * s.options.slidesToShow))
        ...
        i.$slides.each(function (n, s) {
            t = -1 * i.slideWidth * n, !0 === i.options.rtl ? e(s).css({
                position: "relative",
                right: t,
                top: 0,
                zIndex: 800,
        ...
        var n, s, o, r = null,
            a = this;
        return t = t || !1, !0 === a.animating && !0 === a.options.waitForAnimate || !0 === a.options.fade && a.currentSlide === e || a.slideCount <= a.options.slidesToShow ? void 0 : (!1 === t && a.asNavFor(e), n = e, r = a.getLeft(n), o = a.getLeft(a.currentSlide), a.currentLeft = null === a.swipeLeft ? o : a.swipeLeft, !1 === a.options.infinite && !1 === a.options.centerMode && (0 > e || e > a.getDotCount() * a.options.slidesToScroll) ? void(!1 === a.options.fade && (n = a.currentSlide, !0 !== i ? a.animateSlide(o, function () {
            a.postSlide(n)
        }) : a.postSlide(n))) : !1 === a.options.infinite && !0 === a.options.centerMode && (0 > e || e > a.slideCount - a.options.slidesToScroll) ? void(!1 === a.options.fade && (n = a.currentSlide, !0 !== i ? a.animateSlide(o, function () {
            a.postSlide(n)
        }) : a.postSlide(n))) : (!0 === a.options.autoplay && clearInterval(a.autoPlayTimer), s = 0 > n ? 0 != a.slideCount % a.options.slidesToScroll ? a.slideCount - a.slideCount % a.options.slidesToScroll : a.slideCount + n : n >= a.slideCount ? 0 != a.slideCount % a.options.slidesToScroll ? 0 : n - a.slideCount : n, a.animating = !0, a.$slider.trigger("beforeChange", [a, a.currentSlide, s]), a.currentSlide, a.currentSlide = s, a.setSlideClasses(a.currentSlide), a.updateDots(), a.updateArrows(), !0 === a.options.fade ? (!0 !== i ? a.fadeSlide(s, function () {
            a.postSlide(s)
        ...
        for (var e, i = this, n = arguments[0], s = Array.prototype.slice.call(arguments, 1), o = i.length, r = 0; o > r; r++)
            if ("object" == typeof n || void 0 === n ? i[r].slick = new t(i[r], n) : e = i[r].slick[n].apply(i[r].slick, s), void 0 !== e) return e;
        return i
    }
...
function maudio(e) {
    var i = {
            obj: e.obj ? e.obj : "audio",
            fastStep: e.fastStep ? e.fastStep : 10,
            tpl: '    <div class="maudio">      <audio src="" initaudio="false"></audio>      <div class="audio-control">          <a href="javascript:;" class="fast-reverse"></a>          <a href="javascript:;" class="play"></a>          <a href="javascript:;" class="fast-forward"></a>          <div class="progress-bar">              <div class="progress-pass"></div>          </div>          <div class="time-keep">              <span class="current-time">00:00</span> / <span class="duration">00:00</span>          </div>          <a class="mute"></a>          <div class="volume-bar">              <div class="volume-pass"></div>          </div>      </div>    </div>'
        },
        n = $(i.obj).parents(window);
    ...
    $(i.obj).parent(".maudio").length && $(i.obj).next("div.audio-control").length || (window.tDuration = window.tDuration ? window.tDuration : {}, $(i.obj).each(function (e) {
        $(this).before(i.tpl);
        var t = $(this).prev("div.maudio"),
            n = t.children("audio")[0];
        n.src = $(this).attr("src") || $(this).children("source").attr("src"), window.tDuration[i.obj + n.src + "_" + e] = setInterval(function () {
            n.duration && (t.find(".time-keep .duration").text(s(n.duration)), clearInterval(window.tDuration[i.obj + n.src + "_" + e]))
        }, 100), $(this).remove()
    })), $(n).find(".audio-control .play").off("click"), $(n).find(".audio-control .play").on("click", function () {
        var e = $(this).parent(".audio-control").parent(".maudio"),
            i = e.children("audio")[0];
        e.hasClass("playing") ? (i.pause(), e.removeClass("playing")) : ($(n).find(".playing").each(function () {
            $(this).children("audio")[0].pause(), $(this).removeClass("playing")
        }), i.play(), e.addClass("playing"), currentAudio = i, currentAudioBox = e, window.t = window.setInterval(function () {
            var e;
            e = 100 * currentAudio.currentTime / currentAudio.duration, currentAudioBox.find(".progress-pass").css({
                width: e + "%"
            }), currentAudioBox.find(".current-time").text(s(currentAudio.currentTime)), currentAudio.currentTime >= currentAudio.duration && (currentAudioBox.removeClass("playing"), clearInterval(t))
        }, 500))
    }), $(n).find(".audio-control .fast-reverse").off("click"), $(n).find(".audio-control .fast-reverse").on("click", function () {
        currentAudio.currentTime -= i.fastStep
    }), $(n).find(".audio-control .fast-forward").off("click"), $(n).find(".audio-control .fast-forward").on("click", function () {
        currentAudio.currentTime += i.fastStep
    }), $(n).find(".audio-control .volume-bar").off("click"), $(n).find(".audio-control .volume-bar").on("click", function (e) {
        var t = $(this).parent(".audio-control").parent(".maudio"),
            i = t.children("audio")[0],
            n = e.offsetX / t.find(".volume-bar").width();
        t.find(".volume-pass").css({
            width: 100 * n + "%"
        }), i.volume = n > 1 ? 1 : n
    }), $(n).find(".audio-control .mute").off("click"), $(n).find(".audio-control .mute").on("click", function (e) {
        var t = $(this).parent(".audio-control").parent(".maudio").children("audio")[0];
        $(this).hasClass("muted") ? (t.muted = !1, $(this).removeClass("muted")) : (t.muted = !0, $(this).addClass("muted"))
    }), $(n).find(".audio-control .progress-bar").off("click"), $(n).find(".audio-control .progress-bar").on("click", function (e) {
        var t = $(this).parent(".audio-control").parent(".maudio"),
            i = t.children("audio")[0],
            n = e.offsetX / t.find(".progress-bar").width();
        t.find(".progress-pass").css({
            width: 100 * n + "%"
        }), i.currentTime = i.duration * n, t.find(".current-time").text(s(i.currentTime))
    }), $(n).find(".maudio audio").off("play"), $(n).find(".maudio audio").on("play", function () {
        $(this).parent(".maudio").hasClass("playing") || $(this).parent(".maudio").addClass("playing")
    }), $(n).find(".maudio audio").off("pause"), $(n).find(".maudio audio").on("pause", function () {
        $(this).parent(".maudio").hasClass("playing") && $(this).parent(".maudio").removeClass("playing")
    })
}
setActiveStyleSheet(title), maudio({
        obj: "audio",
        fastStep: 10
    }),
    function (e, t) {
        ...
        e.fn.jPlayer = function (i) {
            var n = "jPlayer",
                ...
                r = this;
            return i = !s && o.length ? e.extend.apply(null, [!0, i].concat(o)) : i, s && "_" === i.charAt(0) ? r : (this.each(s ? function () {
                var s = e(this).data(n),
                    a = s && e.isFunction(s[i]) ? s[i].apply(s, o) : s;
                return a !== s && a !== t ? (r = a, !1) : void 0
            } : function () {
                var t = e(this).data(n);
                t ? t.option(i || {}) : e(this).data(n, new e.jPlayer(i, this))
            }), r)
        ...
        i.prototype = {
            ...
            time: function (e) {
                ...
                var t = new Date(1e3 * e),
                    i = t.getUTCHours(),
                    n = this.options.timeFormat.showHour ? t.getUTCMinutes() : t.getUTCMinutes() + 60 * i,
                    s = this.options.timeFormat.showMin ? t.getUTCSeconds() : t.getUTCSeconds() + 60 * n,
                    o = this.options.timeFormat.padHour && 10 > i ? "0" + i : i,
                    r = this.options.timeFormat.padMin && 10 > n ? "0" + n : n,
                    a = this.options.timeFormat.padSec && 10 > s ? "0" + s : s,
                    l = "";
                return l += this.options.timeFormat.showHour ? o + this.options.timeFormat.sepHour : "", (l += this.options.timeFormat.showMin ? r + this.options.timeFormat.sepMin : "") + (this.options.timeFormat.showSec ? a + this.options.timeFormat.sepSec : "")
            }
        };
        var n = new i;
        e.jPlayer.convertTime = function (e) {
            ...
            var t = e.toLowerCase(),
                i = /(webkit)[ \/]([\w.]+)/.exec(t) || /(opera)(?:.*version)?[ \/]([\w.]+)/.exec(t) || /(msie) ([\w.]+)/.exec(t) || t.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+))?/.exec(t) || [];
            return {
                browser: i[1] || "",
                version: i[2] || "0"
            }
            ...
            var t = e.toLowerCase(),
                i = /(ipad|iphone|ipod|android|blackberry|playbook|windows ce|webos)/.exec(t) || [],
                n = /(ipad|playbook)/.exec(t) || !/(mobile)/.exec(t) && /(android)/.exec(t) || [];
        ...
        var o = e.jPlayer.uaPlatform(navigator.userAgent);
        o.platform && (e.jPlayer.platform[o.platform] = !0, e.jPlayer.platform.mobile = !o.tablet, e.jPlayer.platform.tablet = !!o.tablet), e.jPlayer.getDocMode = function () {
            var t;
            ...
            init: function () {
                var e, t, i, n = document,
                    s = n.createElement("video"),
                    o = {
                ...
                for (this.fullscreen = e = {
                        support: {
                            w3c: !!n[o.w3c[0]],
                            moz: !!n[o.moz[0]],
                            webkit: "function" == typeof n[o.webkit[3]],
                            webkitVideo: "function" == typeof s[o.webkitVideo[2]],
                            ms: "function" == typeof s[o.ms[2]]
                        },
                        used: {}
        ...
        var r = function (t) {
            var i, n = e.jPlayer.focus;
            n && (e.each(e.jPlayer.keyIgnoreElementNames.split(/\s+/g), function (e, n) {
                return t.target.nodeName.toUpperCase() === n.toUpperCase() ? (i = !0, !1) : void 0
            }), i || e.each(n.options.keyBindings, function (i, s) {
                return s && e.isFunction(s.fn) && ("number" == typeof s.key && t.which === s.key || "string" == typeof s.key && t.key === s.key) ? (t.preventDefault(), s.fn(n), !1) : void 0
            }))
        };
        e.jPlayer.keys = function (t) {
            var i = "keydown.jPlayer";
            e(document.documentElement).unbind(i), t && e(document.documentElement).bind(i, r)
            ...
            options: {
                ...
                cssSelector: {
                    ...
                    play: ".jp-play, .open-music-player",
                    pause: ".jp-pause",
                    stop: ".jp-stop",
                    seekBar: ".jp-seek-bar",
                    playBar: ".jp-play-bar",
                ...
                if (this.element.empty(), this.status = e.extend({}, this.status), this.internal = e.extend({}, this.internal), this.options.timeFormat = e.extend({}, e.jPlayer.timeFormat, this.options.timeFormat), this.internal.cmdsIgnored = e.jPlayer.platform.ipad || e.jPlayer.platform.iphone || e.jPlayer.platform.ipod, this.internal.domNode = this.element.get(0), this.options.keyEnabled && !e.jPlayer.focus && (e.jPlayer.focus = this), this.androidFix = {
                        ...
                        if (i.format[s]) {
                            ...
                            e.each(i.formats, function (e, t) {
                                return s === t ? (o = !0, !1) : void 0
                            }), o || i.formats.push(s)
                        }
                    }), e.each(this.options.solution.toLowerCase().split(","), function (t, n) {
                        var s = n.replace(/^\s+|\s+$/g, "");
                        if (i.solution[s]) {
                            var o = !1;
                            e.each(i.solutions, function (e, t) {
                                return s === t ? (o = !0, !1) : void 0
                            }), o || i.solutions.push(s)
                        }
                    }), e.each(this.options.auroraFormats.toLowerCase().split(","), function (t, n) {
                        var s = n.replace(/^\s+|\s+$/g, "");
                        if (i.format[s]) {
                            var o = !1;
                            e.each(i.aurora.formats, function (e, t) {
                                return s === t ? (o = !0, !1) : void 0
                            }), o || i.aurora.formats.push(s)
                        }
                        ...
                        jq: t
                    }), e.each(e.jPlayer.event, function (e, n) {
                        i.options[e] !== t && (i.element.bind(n + ".jPlayer", i.options[e]), i.options[e] = t)
                    ...
                    }), this.html.audio.available = !1, this.require.audio && (this.htmlElement.audio = document.createElement("audio"), this.htmlElement.audio.id = this.internal.audio.id, this.html.audio.available = !!this.htmlElement.audio.canPlayType && this._testCanPlayType(this.htmlElement.audio)), this.html.video.available = !1, this.require.video && (this.htmlElement.video = document.createElement("video"), this.htmlElement.video.id = this.internal.video.id, this.html.video.available = !!this.htmlElement.video.canPlayType && this._testCanPlayType(this.htmlElement.video)), this.flash.available = this._checkForFlash(10.1), this.html.canPlay = {}, this.aurora.canPlay = {}, this.flash.canPlay = {}, e.each(this.formats, function (t, n) {
                        i.html.canPlay[n] = i.html[i.format[n].media].available && "" !== i.htmlElement[i.format[n].media].canPlayType(i.format[n].codec), i.aurora.canPlay[n] = e.inArray(n, i.aurora.formats) > -1, i.flash.canPlay[n] = i.format[n].flashCanPlay && i.flash.available
                    }), this.html.desired = !1, this.aurora.desired = !1, this.flash.desired = !1, e.each(this.solutions, function (t, n) {
                        if (0 === t) i[n].desired = !0;
                        else {
                            var s = !1,
                                o = !1;
                            e.each(i.formats, function (e, t) {
                                i[i.solutions[0]].canPlay[t] && ("video" === i.format[t].media ? o = !0 : s = !0)
                            }), i[n].desired = i.require.audio && !s || i.require.video && !o
                        }
                    }), this.html.support = {}, this.aurora.support = {}, this.flash.support = {}, e.each(this.formats, function (e, t) {
                        i.html.support[t] = i.html.canPlay[t] && i.html.desired, i.aurora.support[t] = i.aurora.canPlay[t] && i.aurora.desired, i.flash.support[t] = i.flash.canPlay[t] && i.flash.desired
                    }), this.html.used = !1, this.aurora.used = !1, this.flash.used = !1, e.each(this.solutions, function (t, n) {
                        e.each(i.formats, function (e, t) {
                            return i[n].support[t] ? (i[n].used = !0, !1) : void 0
                        })
                    ...
                    if (e.jPlayer.browser.msie && (Number(e.jPlayer.browser.version) < 9 || e.jPlayer.browser.documentMode < 9)) {
                        var o = '<object id="' + this.internal.flash.id + '" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="0" height="0" tabindex="-1"></object>',
                            r = ['<param name="movie" value="' + this.internal.flash.swf + '" />', '<param name="FlashVars" value="' + s + '" />', '<param name="allowScriptAccess" value="always" />', '<param name="bgcolor" value="' + this.options.backgroundColor + '" />', '<param name="wmode" value="' + this.options.wmode + '" />'];
                        n = document.createElement(o);
                        for (var a = 0; a < r.length; a++) n.appendChild(document.createElement(r[a]))
                    } else {
                        var l = function (e, t, i) {
                            var n = document.createElement("param");
                            n.setAttribute("name", t), n.setAttribute("value", i), e.appendChild(n)
                        };
                        (n = document.createElement("object")).setAttribute("id", this.internal.flash.id), n.setAttribute("name", this.internal.flash.id), n.setAttribute("data", this.internal.flash.swf), n.setAttribute("type", "application/x-shockwave-flash"), n.setAttribute("width", "1"), n.setAttribute("height", "1"), n.setAttribute("tabindex", "-1"), l(n, "flashvars", s), l(n, "allowscriptaccess", "always"), l(n, "bgcolor", this.options.backgroundColor), l(n, "wmode", this.options.wmode)
                    }
                    this.element.append(n), this.internal.flash.jq = e(n)
                }
            ...
            destroyRemoved: function () {
                ...
                e.each(this.instances, function (e, i) {
                    t.element !== i && (i.data("jPlayer") || (i.jPlayer("destroy"), delete t.instances[e]))
                })
            },
            enable: function () {},
            disable: function () {},
            ...
            _uaBlocklist: function (t) {
                ...
                return e.each(t, function (e, t) {
                    return t && t.test(i) ? (n = !0, !1) : void 0
                }), n
            },
            ...
            _addHtmlEventListeners: function (t, i) {
                ...
                t.preload = this.options.preload, t.muted = this.options.muted, t.volume = this.options.volume, this.status.playbackRateEnabled && (t.defaultPlaybackRate = this.options.defaultPlaybackRate, t.playbackRate = this.options.playbackRate), t.addEventListener("progress", function () {
                    i.gate && (n.internal.cmdsIgnored && this.readyState > 0 && (n.internal.cmdsIgnored = !1), n._getHtmlStatus(t), n._updateInterface(), n._trigger(e.jPlayer.event.progress))
                }, !1), t.addEventListener("loadeddata", function () {
                    i.gate && (n.androidFix.setMedia = !1, n.androidFix.play && (n.androidFix.play = !1, n.play(n.androidFix.time)), n.androidFix.pause && (n.androidFix.pause = !1, n.pause(n.androidFix.time)), n._trigger(e.jPlayer.event.loadeddata))
                }, !1), t.addEventListener("timeupdate", function () {
                    i.gate && (n._getHtmlStatus(t), n._updateInterface(), n._trigger(e.jPlayer.event.timeupdate))
                }, !1), t.addEventListener("durationchange", function () {
                    i.gate && (n._getHtmlStatus(t), n._updateInterface(), n._trigger(e.jPlayer.event.durationchange))
                }, !1), t.addEventListener("play", function () {
                    i.gate && (n._updateButtons(!0), n._html_checkWaitForPlay(), n._trigger(e.jPlayer.event.play))
                }, !1), t.addEventListener("playing", function () {
                    i.gate && (n._updateButtons(!0), n._seeked(), n._trigger(e.jPlayer.event.playing))
                }, !1), t.addEventListener("pause", function () {
                    i.gate && (n._updateButtons(!1), n._trigger(e.jPlayer.event.pause))
                }, !1), t.addEventListener("waiting", function () {
                    i.gate && (n._seeking(), n._trigger(e.jPlayer.event.waiting))
                }, !1), t.addEventListener("seeking", function () {
                    i.gate && (n._seeking(), n._trigger(e.jPlayer.event.seeking))
                }, !1), t.addEventListener("seeked", function () {
                    i.gate && (n._seeked(), n._trigger(e.jPlayer.event.seeked))
                }, !1), t.addEventListener("volumechange", function () {
                    i.gate && (n.options.volume = t.volume, n.options.muted = t.muted, n._updateMute(), n._updateVolume(), n._trigger(e.jPlayer.event.volumechange))
                }, !1), t.addEventListener("ratechange", function () {
                    i.gate && (n.options.defaultPlaybackRate = t.defaultPlaybackRate, n.options.playbackRate = t.playbackRate, n._updatePlaybackRate(), n._trigger(e.jPlayer.event.ratechange))
                }, !1), t.addEventListener("suspend", function () {
                    i.gate && (n._seeked(), n._trigger(e.jPlayer.event.suspend))
                }, !1), t.addEventListener("ended", function () {
                    i.gate && (e.jPlayer.browser.webkit || (n.htmlElement.media.currentTime = 0), n.htmlElement.media.pause(), n._updateButtons(!1), n._getHtmlStatus(t, !0), n._updateInterface(), n._trigger(e.jPlayer.event.ended))
                }, !1), t.addEventListener("error", function () {
                    i.gate && (n._updateButtons(!1), n._seeked(), n.status.srcSet && (clearTimeout(n.internal.htmlDlyCmdId), n.status.waitForLoad = !0, n.status.waitForPlay = !0, n.status.video && !n.status.nativeVideoControls && n.internal.video.jq.css({
                        width: "0px",
                        height: "0px"
                ...
                }, !1), e.each(e.jPlayer.htmlEvent, function (s, o) {
                    t.addEventListener(this, function () {
                        i.gate && n._trigger(e.jPlayer.event[o])
                    }, !1)
                })
            },
            _addAuroraEventListeners: function (t, i) {
                var n = this;
                t.volume = 100 * this.options.volume, t.on("progress", function () {
                    i.gate && (n.internal.cmdsIgnored && this.readyState > 0 && (n.internal.cmdsIgnored = !1), n._getAuroraStatus(t), n._updateInterface(), n._trigger(e.jPlayer.event.progress), t.duration > 0 && n._trigger(e.jPlayer.event.timeupdate))
                }, !1), t.on("ready", function () {
                    i.gate && n._trigger(e.jPlayer.event.loadeddata)
                }, !1), t.on("duration", function () {
                    i.gate && (n._getAuroraStatus(t), n._updateInterface(), n._trigger(e.jPlayer.event.durationchange))
                }, !1), t.on("end", function () {
                    i.gate && (n._updateButtons(!1), n._getAuroraStatus(t, !0), n._updateInterface(), n._trigger(e.jPlayer.event.ended))
                }, !1), t.on("error", function () {
                    i.gate && (n._updateButtons(!1), n._seeked(), n.status.srcSet && (n.status.waitForLoad = !0, n.status.waitForPlay = !0, n.status.video && !n.status.nativeVideoControls && n.internal.video.jq.css({
                        width: "0px",
                        height: "0px"
                    }), n._validString(n.status.media.poster) && !n.status.nativeVideoControls && n.internal.poster.jq.show(), n.css.jq.videoPlay.length && n.css.jq.videoPlay.show(), n._error({
                        type: e.jPlayer.error.URL,
                    ...
                    if (this.internal.ready) {
                        if (this.flash.gate) {
                            if (this.status.srcSet) {
                                ...
                                this.setMedia(this.status.media), this.volumeWorker(this.options.volume), n > 0 && (s ? this.pause(n) : this.play(n))
                            }
            ...
            _updateInterface: function () {
                ...
                this.css.jq.duration.length && ("string" == typeof this.status.media.duration ? e = this.status.media.duration : ("number" == typeof this.status.media.duration && (i = (t = this.status.media.duration) - this.status.currentTime), e = this.options.remainingDuration ? (i > 0 ? "-" : "") + this._convertTime(i) : this._convertTime(t)), e !== this.css.jq.duration.text() && this.css.jq.duration.text(e))
            },
            ...
            _absoluteMediaUrls: function (t) {
                ...
                return e.each(t, function (e, n) {
                    n && i.format[e] && "data:" !== n.substr(0, 5) && (t[e] = i._qualifyURL(n))
                }), t
            },
            ...
            setMedia: function (t) {
                ...
                this._resetMedia(), this._resetGate(), this._resetActive(), this.androidFix.setMedia = !1, this.androidFix.play = !1, this.androidFix.pause = !1, t = this._absoluteMediaUrls(t), e.each(this.formats, function (s, o) {
                    var r = "video" === i.format[o].media;
                    return e.each(i.solutions, function (s, a) {
                        if (i[a].support[o] && i._validString(t[o])) {
                            var l = "html" === a,
                                u = "aurora" === a;
                            return r ? (l ? (i.html.video.gate = !0, i._html_setVideo(t), i.html.active = !0) : (i.flash.gate = !0, i._flash_setVideo(t), i.flash.active = !0), i.css.jq.videoPlay.length && i.css.jq.videoPlay.show(), i.status.video = !0) : (l ? (i.html.audio.gate = !0, i._html_setAudio(t), i.html.active = !0, e.jPlayer.platform.android && (i.androidFix.setMedia = !0)) : u ? (i.aurora.gate = !0, i._aurora_setAudio(t), i.aurora.active = !0) : (i.flash.gate = !0, i._flash_setAudio(t), i.flash.active = !0), i.css.jq.videoPlay.length && i.css.jq.videoPlay.hide(), i.status.video = !1), n = !0, !1
                        }
                    }), !n && void 0
            ...
            tellOthers: function (t, i) {
                var n = this,
                    s = "function" == typeof i,
                    o = Array.prototype.slice.call(arguments);
                "string" == typeof t && (s && o.splice(1, 1), e.jPlayer.prototype.destroyRemoved(), e.each(this.instances, function () {
                    n.element !== this && (!s || i.call(this.data("jPlayer"), n)) && this.jPlayer.apply(this, o)
                }))
            },
            ...
            volumeBar: function (t) {
                if (this.css.jq.volumeBar.length) {
                    var i = e(t.currentTarget),
                        ...
                        s = t.pageX - n.left,
                        o = i.width(),
                        r = i.height() - t.pageY + n.top,
                        a = i.height();
                    this.volume(this.options.verticalVolume ? r / a : s / o)
                }
            ...
            _cssSelector: function (t, i) {
                ...
                if ("string" == typeof i)
                    if (e.jPlayer.prototype.options.cssSelector[t]) {
                        if (this.css.jq[t] && this.css.jq[t].length && this.css.jq[t].unbind(".jPlayer"), this.options.cssSelector[t] = i, this.css.cs[t] = this.options.cssSelectorAncestor + " " + i, this.css.jq[t] = i ? e(this.css.cs[t]) : [], this.css.jq[t].length && this[t]) {
                            this.css.jq[t].bind("click.jPlayer", function (i) {
                                i.preventDefault(), n[t](i), n.options.autoBlur ? e(this).blur() : e(this).focus()
                            })
                        }
            ...
            playbackRateBar: function (t) {
                if (this.css.jq.playbackRateBar.length) {
                    var i, n = e(t.currentTarget),
                        ...
                        o = t.pageX - s.left,
                        r = n.width(),
                        a = n.height() - t.pageY + s.top,
                        l = n.height();
                    i = (this.options.verticalPlaybackRate ? a / l : o / r) * (this.options.maxPlaybackRate - this.options.minPlaybackRate) + this.options.minPlaybackRate, this.playbackRate(i)
                }
            },
            _updatePlaybackRate: function () {
                var e = (this.options.playbackRate - this.options.minPlaybackRate) / (this.options.maxPlaybackRate - this.options.minPlaybackRate);
            ...
            repeat: function (e) {
                ...
                this._loop(!(t && this.options.useStateClassSkin && this.options.loop))
            },
            repeatOff: function () {
                this._loop(!1)
            },
            ...
            option: function (i, n) {
                ...
                if ("string" == typeof i) {
                    var o = i.split(".");
                    if (n === t) {
                        for (var r = e.extend(!0, {}, this.options), a = 0; a < o.length; a++) {
                            if (r[o[a]] === t) return this._warning({
                    ...
                    for (var l = s = {}, u = 0; u < o.length; u++) u < o.length - 1 ? (l[o[u]] = {}, l = l[o[u]]) : l[o[u]] = n
                }
            ...
            _setOption: function (t, i) {
                ...
                switch (t) {
                    ...
                    case "cssSelector":
                        ...
                        break;
                    case "playbackRate":
                        this.options[t] = i = this._limitValue(i, this.options.minPlaybackRate, this.options.maxPlaybackRate), this.html.used && this._html_setProperty("playbackRate", i), this._updatePlaybackRate();
                        break;
                    case "defaultPlaybackRate":
                        this.options[t] = i = this._limitValue(i, this.options.minPlaybackRate, this.options.maxPlaybackRate), this.html.used && this._html_setProperty("defaultPlaybackRate", i), this._updatePlaybackRate();
                        break;
                    case "minPlaybackRate":
                        this.options[t] = i = this._limitValue(i, .1, this.options.maxPlaybackRate - .1), this._updatePlaybackRate();
                        break;
                    case "maxPlaybackRate":
                        this.options[t] = i = this._limitValue(i, this.options.minPlaybackRate + .1, 16), this._updatePlaybackRate();
                        break;
                    case "fullScreen":
                        if (this.options[t] !== i) {
                            var s = e.jPlayer.nativeFeatures.fullscreen.used.webkitVideo;
                            (!s || s && !this.status.waitForPlay) && (s || (this.options[t] = i), i ? this._requestFullscreen() : this._exitFullscreen(), s || this._setOption("fullWindow", i))
                        }
                        break;
                    case "fullWindow":
                    ...
                    case "remainingDuration":
                        this.options[t] = i, this._updateInterface();
                        break;
                    case "toggleDuration":
                        this.options[t] = i;
                        break;
                    ...
                    case "noVolume":
                        ...
                        break;
                    case "emulateHtml":
                        this.options[t] !== i && (this.options[t] = i, i ? this._emulateHtmlBridge() : this._destroyHtmlBridge());
                        break;
                    case "timeFormat":
            ...
            _updateAutohide: function () {
                var e = this,
                    t = ".jPlayerAutohide",
                    i = "mousemove.jPlayer" + t,
                    n = function (t) {
                        var i, n, s = !1;
                        void 0 !== e.internal.mouse ? (i = e.internal.mouse.x - t.pageX, n = e.internal.mouse.y - t.pageY, s = Math.floor(i) > 0 || Math.floor(n) > 0) : s = !0, e.internal.mouse = {
                            x: t.pageX,
                            y: t.pageY
                ...
                this.css.jq.gui.length && (this.css.jq.gui.stop(!0, !0), clearTimeout(this.internal.autohideId), delete this.internal.mouse, this.element.unbind(t), this.css.jq.gui.unbind(t), this.status.nativeVideoControls ? this.css.jq.gui.hide() : this.options.fullWindow && this.options.autohide.full || !this.options.fullWindow && this.options.autohide.restored ? (this.element.bind(i, n), this.css.jq.gui.bind(i, n), this.css.jq.gui.hide()) : this.css.jq.gui.show())
            },
            ...
            _html_initMedia: function (t) {
                ...
                e.each(t.track || [], function (e, t) {
                    ...
                    n.setAttribute("kind", t.kind ? t.kind : ""), n.setAttribute("src", t.src ? t.src : ""), n.setAttribute("srclang", t.srclang ? t.srclang : ""), n.setAttribute("label", t.label ? t.label : ""), t.def && n.setAttribute("default", t.def), i.append(n)
            ...
            _html_setFormat: function (t) {
                var i = this;
                e.each(this.formats, function (e, n) {
                    return i.html.support[n] && t[n] ? (i.status.src = t[n], i.status.format[n] = !0, i.status.formatType = n, !1) : void 0
                })
            },
            ...
            _html_pause: function (e) {
                var t = this,
                    i = this.htmlElement.media;
                if (this.androidFix.play = !1, e > 0 ? this._html_load() : clearTimeout(this.internal.htmlDlyCmdId), i.pause(), this.androidFix.setMedia) this.androidFix.pause = !0, this.androidFix.time = e;
                else if (!isNaN(e)) try {
                    if (i.seekable && !("object" == typeof i.seekable && i.seekable.length > 0)) throw 1;
                    i.currentTime = e
                } catch (i) {
            ...
            _html_playHead: function (e) {
                ...
                this._html_load();
                try {
                    if ("object" == typeof i.seekable && i.seekable.length > 0) i.currentTime = e * i.seekable.end(i.seekable.length - 1) / 100;
                    else {
            ...
            _aurora_setAudio: function (t) {
                var i = this;
                e.each(this.formats, function (e, n) {
                    return i.aurora.support[n] && t[n] ? (i.status.src = t[n], i.status.format[n] = !0, i.status.formatType = n, !1) : void 0
            ...
            _flash_setAudio: function (t) {
                ...
                try {
                    e.each(this.formats, function (e, n) {
                        if (i.flash.support[n] && t[n]) {
                            switch (n) {
                                case "m4a":
                                case "fla":
                                    i._getMovie().fl_setAudio_m4a(t[n]);
                                    break;
                                case "mp3":
                                    i._getMovie().fl_setAudio_mp3(t[n]);
                                    break;
                                case "rtmpa":
                                    i._getMovie().fl_setAudio_rtmp(t[n])
                            }
                            return i.status.src = t[n], i.status.format[n] = !0, i.status.formatType = n, !1
                        }
                    ...
                    e.each(this.formats, function (e, n) {
                        if (i.flash.support[n] && t[n]) {
                            switch (n) {
                                case "m4v":
                                case "flv":
                                    i._getMovie().fl_setVideo_m4v(t[n]);
                                    break;
                                case "rtmpv":
                                    i._getMovie().fl_setVideo_rtmp(t[n])
                            }
                            return i.status.src = t[n], i.status.format[n] = !0, i.status.formatType = n, !1
                        }
                    }), "auto" === this.options.preload && (this._flash_load(), this.status.waitForLoad = !1)
            ...
            _getFlashPluginVersion: function () {
                ...
                } catch (e) {} else navigator.plugins && navigator.mimeTypes.length > 0 && ((e = navigator.plugins["Shockwave Flash"]) && (t = navigator.plugins["Shockwave Flash"].description.replace(/.*\s(\d+\.\d+).*/, "$1")));
                return 1 * t
            },
            ...
            _emulateHtmlBridge: function () {
                ...
                }), e.each(e.jPlayer.event, function (i, n) {
                    var s = !0;
                    e.each(e.jPlayer.reservedEvent.split(/\s+/g), function (e, t) {
                        return t === i ? (s = !1, !1) : void 0
                    }), s && t.element.bind(n + ".jPlayer.jPlayerHtml", function () {
            ...
            _destroyHtmlBridge: function () {
                ...
                e.each(i.split(/\s+/g), function (e, i) {
    ...
    function (e, t) {
        jPlayerPlaylist = function (t, i, n) {
            var s = this;
            this.current = 0, this.loop = !1, this.shuffled = !1, this.removing = !1, this.cssSelector = e.extend({}, this._cssSelector, t), this.options = e.extend(!0, {
                ...
                t.jPlayer.options.fullScreen ? e(s.cssSelector.details).show() : e(s.cssSelector.details).hide()
            }), e(this.cssSelector.previous).click(function (e) {
                e.preventDefault(), s.previous(), s.blur(this)
            }), e(this.cssSelector.next).click(function (e) {
                e.preventDefault(), s.next(), s.blur(this)
            }), e(this.cssSelector.shuffle).click(function (t) {
                t.preventDefault(), s.shuffle(!s.shuffled || !e(s.cssSelector.jPlayer).jPlayer("option", "useStateClassSkin")), s.blur(this)
            }), e(this.cssSelector.shuffleOff).click(function (e) {
                e.preventDefault(), s.shuffle(!1), s.blur(this)
            ...
            _refresh: function (t) {
                ...
                if (t && !e.isFunction(t)) e(this.cssSelector.playlist + " ul").empty(), e.each(this.playlist, function (t) {
                    ...
                    var n = e(this.cssSelector.playlist + " ul").children().length ? this.options.playlistOptions.displayTime : 0;
                    e(this.cssSelector.playlist + " ul").slideUp(n, function () {
                        var n = e(this);
                        e(this).empty(), e.each(i.playlist, function (e) {
                            n.append(i._createListItem(i.playlist[e]))
            ...
            _createListItem: function (t) {
                var i = this,
                    n = "<li><div>";
                if (n += "<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "'>&times;</a>", t.free) {
                    var s = !0;
                    n += "<span class='" + this.options.playlistOptions.freeGroupClass + "'>(", e.each(t, function (t, o) {
                        e.jPlayer.prototype.format[t] && (s ? s = !1 : n += " | ", n += "<a class='" + i.options.playlistOptions.freeItemClass + "' href='" + o + "' tabindex='-1'>" + t + "</a>")
                    }), n += ")</span>"
                }
                return n += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'>" + t.title + (t.artist ? " <span class='jp-artist'>by " + t.artist + "</span>" : "") + "</a>", n += "</div></li>"
            },
            _createItemHandlers: function () {
                ...
                e(this.cssSelector.playlist).off("click", "a." + this.options.playlistOptions.itemClass).on("click", "a." + this.options.playlistOptions.itemClass, function (i) {
                    ...
                    t.current !== n ? t.play(n) : e(t.cssSelector.jPlayer).jPlayer("play"), t.blur(this)
            ...
            remove: function (i) {
                ...
                return i === t ? (this._initPlaylist([]), this._refresh(function () {
                    e(n.cssSelector.jPlayer).jPlayer("clearMedia")
                }), !0) : !this.removing && ((i = 0 > i ? n.original.length + i : i) >= 0 && i < this.playlist.length && (this.removing = !0, e(this.cssSelector.playlist + " li:nth-child(" + (i + 1) + ")").slideUp(this.options.playlistOptions.removeTime, function () {
                    if (e(this).remove(), n.shuffled) {
                        var t = n.playlist[i];
                        e.each(n.original, function (e) {
                            return n.original[e] === t ? (n.original.splice(e, 1), !1) : void 0
                        }), n.playlist.splice(i, 1)
                    } else n.original.splice(i, 1), n.playlist.splice(i, 1);
                    n.original.length ? i === n.current ? (n.current = i < n.original.length ? n.current : n.original.length - 1, n.select(n.current)) : i < n.current && n.current-- : (e(n.cssSelector.jPlayer).jPlayer("clearMedia"), n.current = 0, n.shuffled = !1, n._updateControls()), n.removing = !1
                })), !0)
            },
            select: function (t) {
                (t = 0 > t ? this.original.length + t : t) >= 0 && t < this.playlist.length ? (this.current = t, this._highlight(t), e(this.cssSelector.jPlayer).jPlayer("setMedia", this.playlist[this.current])) : this.current = 0
            },
            play: function (i) {
                (i = 0 > i ? this.original.length + i : i) >= 0 && i < this.playlist.length ? this.playlist.length && (this.select(i), e(this.cssSelector.jPlayer).jPlayer("play")) : i === t && e(this.cssSelector.jPlayer).jPlayer("play")
            },
            pause: function () {
            ...
            shuffle: function (i, n) {
                ...
                i === t && (i = !this.shuffled), (i || i !== this.shuffled) && e(this.cssSelector.playlist + " ul").slideUp(this.options.playlistOptions.shuffleTime, function () {
                    s.shuffled = i, i ? s.playlist.sort(function () {
                        return .5 - Math.random()
                    }) : s._originalPlaylist(), s._refresh(!0), n || !e(s.cssSelector.jPlayer).data("jPlayer").status.paused ? s.play(0) : s.select(0), e(this).slideDown(s.options.playlistOptions.shuffleTime)
                })
            },
            blur: function (t) {
        ...
        new jPlayerPlaylist({
            ...
            title: "HVME GOOSEBUMPS Extended",
            mp3: "media/HVME-GOOSEBUMPS_Extended.mp3",
            oga: "http://www.jplayer.org/audio/ogg/TSP-01-Cro_magnon_man.ogg"
        },{
            title: "Friendships",
            mp3: "media/Friendships.mp3",
            oga: "http://www.jplayer.org/audio/ogg/TSP-01-Cro_magnon_man.ogg"
        },{
            title: "JONY - Love Your Voice",
            mp3: "media/JONY-Love-Your-Voice.mp3",
            oga: "http://www.jplayer.org/audio/ogg/TSP-01-Cro_magnon_man.ogg"
        },{
            title: "Lut Gaye Jubin Nautiyal",
            mp3: "media/Lut_Gaye_Jubin_Nautiyal.mp3",
            oga: "http://www.jplayer.org/audio/ogg/TSP-01-Cro_magnon_man.ogg"
        },{
            title: "Saiya Ji",
            mp3: "media/Saiya_Ji.mp3",
            oga: "http://www.jplayer.org/audio/ogg/TSP-01-Cro_magnon_man.ogg"
        },{
...
$(window).on("load", function () {
    ...
    $(".open-music-player").on("click", function () {
        return $(".beatx-playyer.fixed-player").addClass("show"), $(this).toggleClass("playy"), !1
    }), $(".remove-music-player").on("click", function () {
        return $(".beatx-playyer").removeClass("show"), $(".remove-music-player.v2").addClass("show"), !1
        ...
        return $(".responsive-mobile-menu").toggleClass("active"), !1
    }), $(".close-menu, html").on("click", function () {
        $(".responsive-mobile-menu").removeClass("active")
    }), $(".responsive-mobile-menu ul ul").parent().addClass("menu-item-has-children"), $(".responsive-mobile-menu ul li.menu-item-has-children > a").on("click", function () {
        return $(this).parent().toggleClass("active").siblings().removeClass("active"), $(this).next("ul").slideToggle(), $(this).parent().siblings().find("ul").slideUp(), !1
    ...
    }), $(".btn-default").length && $(".btn-default").on("mouseenter", function (e) {
        var n = $(this).offset(),
            t = e.pageX - n.left,
            o = e.pageY - n.top;
        $(this).find("span").css({
    ...
    }), $("#contact-form").length && $("#submit").on("click", function () {
        new Object;
        var e = $("#contact-form .name").val(),
            n = $("#contact-form .email").val();
        if ("" == e || "" == n) return $("#contact-form .response").html('<div class="failed">Please fill the required fields.</div>'), !1;
        $.ajax({
            url: "sendmail.php",
            method: "POST",
            ...
            success: function (e) {
                $("form").trigger("reset"), $("#contact-form .response").fadeIn().html(e), setTimeout(function () {
        ...
        $(this).scrollTop() > 1 ? $(".bottom-header").addClass("sticky animated slideInDown") : $(".bottom-header").removeClass("sticky animated slideInDown")
    }), $(".banner-text .btn-default.demos").on("click", function (e) {
        if ("" !== this.hash) {
            e.preventDefault();
            var n = this.hash;
            $("html, body").animate({
