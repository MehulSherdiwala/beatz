<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMaster.Master" AutoEventWireup="true" CodeBehind="edit_genre.aspx.cs" Inherits="beatz.admin.edit_genre" %>
                 ...
                 <div class="card-body">
                       <div class="pl-lg-4 pt-4">
                          ...
                          <div class="row flex justify-content-center">
                              ...
                              <asp:Button ID="editGenre" runat="server" CssClass="btn btn-success px-5 my-4" Text="Save Genre" OnClick="editGenre_Click" />
                          </div>
                       </div>
                 </div>
            </div>
