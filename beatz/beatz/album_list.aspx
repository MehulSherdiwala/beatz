<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="album_list.aspx.cs" Inherits="beatz.album_list" %>
<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="pod-series">
					...
					<div id="togglebutton" style="cursor:pointer" class="border shadow border-success p-3 rounded-circle text-success play_playlist"  data-playlist="<%= Request.QueryString["album"] %>"><i id="play" class="fa fa-play" aria-hidden="true"></i></div>
					</div>
