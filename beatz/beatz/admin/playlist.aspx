<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMaster.Master" AutoEventWireup="true" CodeBehind="playlist.aspx.cs" Inherits="beatz.admin.playlist" %>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="./add_playlist.aspx" class="btn btn-secondary text-success">Add Playlist</a>
            </div>
          </div>
        </div>
      </div>
